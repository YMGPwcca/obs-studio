...
Candidate measurement HEAD: `5d603325f229c391ed2539dfba24e6be0e920935`

## Named-function before/after summary

| Measure | Before | After |
|---|---:|---:|
| Named functions | 543 | 2706 |
| Average named-function CC | 5.703 | 3.997 |
| Median named-function CC | 4 | 3 |
| 90th percentile named-function CC | 13 | 8 |
| Maximum named-function CC | 61 | 13 |
| Named functions with CC > 5 | 171 | 659 |
| Named functions with CC > 7 | 115 | 297 |
...
|---|---:|---:|
| Script bodies | 5 | 103 |
| Average Script bodies CC | 36.2 | 2.738 |
| Median Script bodies CC | 26 | 2 |
| 90th percentile Script bodies CC | 80 | 5 |
| Maximum Script bodies CC | 80 | 9 |
| Script bodies with CC > 5 | 4 | 9 |
| Script bodies with CC > 7 | 4 | 2 |
...
| Measure | Before | After |
|---|---:|---:|
| Enforced scopes | 548 | 2809 |
| Average Enforced scopes CC | 5.982 | 3.951 |
| Median Enforced scopes CC | 4 | 3 |
| 90th percentile Enforced scopes CC | 13 | 8 |
| Maximum Enforced scopes CC | 80 | 13 |
| Enforced scopes with CC > 5 | 175 | 668 |
| Enforced scopes with CC > 7 | 119 | 299 |
...
Owned run blocks: 113; substantial inline PowerShell: 0; unsupported substantial blocks: 0
...
| `.github/workflows/engine-protocol-v2-task21.yaml` | `audio-v1` | Audit normal package | `pwsh` | 29-29 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task21.yaml` | `audio-v1` | Build CI-only audio fixture | `pwsh` | 32-32 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task21.yaml` | `audio-v1` | Stage CI-only audio fixture | `pwsh` | 35-35 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task21.yaml` | `audio-v1` | Run Task 21 audio integration | `pwsh` | 38-38 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task21.yaml` | `audio-v1` | Remove CI-only audio fixture | `pwsh` | 42-42 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task21.yaml` | `audio-v1` | Audit package after fixture cleanup | `pwsh` | 46-46 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task22.yaml` | `hotkey-v1` | Audit normal package | `pwsh` | 29-29 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task22.yaml` | `hotkey-v1` | Build CI-only hotkey fixture | `pwsh` | 32-32 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task22.yaml` | `hotkey-v1` | Stage CI-only hotkey fixture | `pwsh` | 35-35 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task22.yaml` | `hotkey-v1` | Run Task 22 hotkey integration | `pwsh` | 38-38 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task22.yaml` | `hotkey-v1` | Remove CI-only hotkey fixture | `pwsh` | 42-42 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task22.yaml` | `hotkey-v1` | Audit package after fixture cleanup | `pwsh` | 46-46 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task23.yaml` | `encoder-v1` | Audit normal package | `pwsh` | 29-29 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task23.yaml` | `encoder-v1` | Build CI-only encoder fixture | `pwsh` | 32-32 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task23.yaml` | `encoder-v1` | Stage CI-only encoder fixture | `pwsh` | 35-35 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task23.yaml` | `encoder-v1` | Run Task 23 encoder integration | `pwsh` | 38-38 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task23.yaml` | `encoder-v1` | Run active encoder update bridge test | `pwsh` | 41-41 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task23.yaml` | `encoder-v1` | Remove CI-only encoder fixture | `pwsh` | 45-45 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task23.yaml` | `encoder-v1` | Audit package after fixture cleanup | `pwsh` | 49-49 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task24.yaml` | `encoder-group-v1` | Audit normal package | `pwsh` | 29-29 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task24.yaml` | `encoder-group-v1` | Build CI-only encoder fixture | `pwsh` | 32-32 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task24.yaml` | `encoder-group-v1` | Stage CI-only encoder fixture | `pwsh` | 35-35 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task24.yaml` | `encoder-group-v1` | Run Task 24 encoder group integration | `pwsh` | 38-38 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task24.yaml` | `encoder-group-v1` | Remove CI-only encoder fixture | `pwsh` | 42-42 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task24.yaml` | `encoder-group-v1` | Audit package after fixture cleanup | `pwsh` | 46-46 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task25.yaml` | `service-v1` | Audit normal package | `pwsh` | 29-29 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task25.yaml` | `service-v1` | Build CI-only service fixture | `pwsh` | 32-32 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task25.yaml` | `service-v1` | Stage CI-only service fixture | `pwsh` | 35-35 | 1 | TRIVIAL_WRAPPER | — |
...
| `.github/workflows/engine-protocol-v2-task27.yaml` | `recording-v1` | Audit normal package | `pwsh` | 29-29 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task27.yaml` | `recording-v1` | Build CI-only recording fixtures | `pwsh` | 32-32 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task27.yaml` | `recording-v1` | Stage CI-only recording fixtures | `pwsh` | 35-35 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task27.yaml` | `recording-v1` | Run Task 27 recording integration | `pwsh` | 38-38 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task27.yaml` | `recording-v1` | Remove CI-only recording fixtures | `pwsh` | 42-42 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task27.yaml` | `recording-v1` | Audit package after fixture cleanup | `pwsh` | 46-46 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task28.yaml` | `streaming-v1` | Audit normal package | `pwsh` | 29-29 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task28.yaml` | `streaming-v1` | Build CI-only streaming fixtures | `pwsh` | 32-32 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task28.yaml` | `streaming-v1` | Stage CI-only streaming fixtures | `pwsh` | 35-35 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task28.yaml` | `streaming-v1` | Run Task 28 streaming integration | `pwsh` | 38-38 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task28.yaml` | `streaming-v1` | Remove CI-only streaming fixtures | `pwsh` | 42-42 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task28.yaml` | `streaming-v1` | Audit package after fixture cleanup | `pwsh` | 46-46 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task29.yaml` | `replay-buffer-v1` | Audit normal package | `pwsh` | 29-29 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task29.yaml` | `replay-buffer-v1` | Build CI-only replay fixtures | `pwsh` | 32-32 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task29.yaml` | `replay-buffer-v1` | Stage CI-only replay fixtures | `pwsh` | 35-35 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task29.yaml` | `replay-buffer-v1` | Run Task 29 replay-buffer integration | `pwsh` | 38-38 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task29.yaml` | `replay-buffer-v1` | Remove CI-only replay fixtures | `pwsh` | 42-42 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task29.yaml` | `replay-buffer-v1` | Audit package after fixture cleanup | `pwsh` | 46-46 | 1 | TRIVIAL_WRAPPER | — |
...
| `.github/workflows/engine-protocol-v2-task30.yaml` | `virtual-camera-v1` | Audit normal package | `pwsh` | 29-29 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task30.yaml` | `virtual-camera-v1` | Run Task 30 virtual-camera integration | `pwsh` | 32-32 | 1 | TRIVIAL_WRAPPER | — |
| `.github/workflows/engine-protocol-v2-task30.yaml` | `virtual-camera-v1` | Audit package after integration | `pwsh` | 36-36 | 1 | TRIVIAL_WRAPPER | — |
...
| `obs_engine::Engine::v2_virtual_camera_configure` | `engine/runtime_virtual_camera_v2.cpp` | — | 10 | — | 55 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_recording_add_chapter` | `engine/runtime_recording_v2.cpp` | — | 10 | — | 37 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_sync_source_observers` | `engine/runtime_source_v2.cpp` | 15 | 10 | 58 | 36 | reduced by 5 |
| `obs_engine::Engine::v2_canvas_remove` | `engine/runtime_canvas_v2.cpp` | — | 10 | — | 35 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_canvas_set_video_settings` | `engine/runtime_canvas_v2.cpp` | — | 10 | — | 32 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_item_create_group` | `engine/runtime_item_v2.cpp` | — | 10 | — | 32 | new cohesive helper/function in scoped file |
| `obs_encoder_update_tracked` | `libobs/obs-encoder.c` | — | 10 | — | 32 | new cohesive helper/function in scoped file |
| `init_encoder` | `libobs/obs-encoder.c` | — | 10 | — | 31 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_settle_filter_mutation` | `engine/runtime_filter_v2.cpp` | 16 | 10 | 36 | 30 | reduced by 6 |
| `obs_engine::Engine::v2_output_remove` | `engine/runtime_output_v2.cpp` | — | 10 | — | 30 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_streaming_configure` | `engine/runtime_streaming_v2.cpp` | — | 10 | — | 25 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_clear_secrets` | `engine/runtime_service_v2.cpp` | — | 10 | — | 24 | new cohesive helper/function in scoped file |
...
| `obs_engine::execute_phase3` | `engine/protocol_phase3_v2.cpp` | — | 10 | — | 23 | new cohesive helper/function in scoped file |
| `obs_engine::prepare` | `engine/protocol_phase2_v2.cpp` | — | 10 | — | 22 | new cohesive helper/function in scoped file |
| `obs_engine::phase3_dispatch_is_mutating` | `engine/protocol_phase3_v2.cpp` | — | 10 | — | 22 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_hotkey_selector` | `engine/runtime_hotkey_v2.cpp` | — | 10 | — | 20 | new cohesive helper/function in scoped file |
...
| `obs_engine::normalize_replay_path` | `engine/runtime_replay_buffer_v2.cpp` | — | 10 | — | 18 | new cohesive helper/function in scoped file |
...
| `Assert-Task28LoopbackFiles` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 10 | — | 17 | new cohesive helper/function in scoped file |
| `obs_engine::read_video_input_descriptor` | `engine/runtime_encoder_v2.cpp` | — | 10 | — | 17 | new cohesive helper/function in scoped file |
| `obs_engine::filter_settings_event_matches` | `engine/runtime_filter_v2.cpp` | 10 | 10 | 17 | 17 | unchanged |
| `obs_engine::read_meter_options` | `engine/runtime_audio_v2.cpp` | — | 10 | — | 16 | new cohesive helper/function in scoped file |
| `Get-Task22HotkeyFixtures` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 10 | — | 15 | new cohesive helper/function in scoped file |
| `obs_engine::read_scaled_dimensions` | `engine/runtime_encoder_v2.cpp` | — | 10 | — | 15 | new cohesive helper/function in scoped file |
| `Get-WorkflowInterpreter` | `tools/check-complexity.ps1` | — | 10 | — | 14 | new cohesive helper/function in scoped file |
| `obs_engine::is_phase3_method` | `engine/protocol_phase3_v2.cpp` | — | 10 | — | 12 | new cohesive helper/function in scoped file |
| `obs_engine::output_kind_supports_proc` | `engine/runtime_recording_v2.cpp` | — | 10 | — | 12 | new cohesive helper/function in scoped file |
| `Assert-ColorEvidence` | `.github/scripts/engine-protocol-v2-task17.ps1` | — | 10 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::phase3_dispatch_empty` | `engine/protocol_phase3_v2.cpp` | — | 10 | — | 9 | new cohesive helper/function in scoped file |
...
| `Invoke-Task22BindingChecks` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 9 | — | 52 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_replay_buffer_save` | `engine/runtime_replay_buffer_v2.cpp` | — | 9 | — | 47 | new cohesive helper/function in scoped file |
...
| `main` | `engine/task23_encoder_bridge_test.cpp` | — | 9 | — | 44 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_transition_create` | `engine/runtime_transition_v2.cpp` | — | 9 | — | 43 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_source_remove` | `engine/runtime_v2.cpp` | 9 | 9 | 40 | 43 | unchanged |
...
| `obs_engine::Engine::v2_prepare_audio_shutdown` | `engine/runtime_audio_v2.cpp` | — | 9 | — | 36 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_filter_prepare_parent_removal` | `engine/runtime_filter_v2.cpp` | 9 | 9 | 36 | 36 | unchanged |
| `obs_engine::Engine::v2_service_create` | `engine/runtime_service_v2.cpp` | — | 9 | — | 36 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_replay_buffer_configure` | `engine/runtime_replay_buffer_v2.cpp` | — | 9 | — | 32 | new cohesive helper/function in scoped file |
...
| `obs_engine::update_scalar_audio_observer` | `engine/runtime_audio_v2.cpp` | — | 9 | — | 31 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_sanitize_output_error` | `engine/runtime_output_v2.cpp` | — | 9 | — | 30 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_recording_split_file` | `engine/runtime_recording_v2.cpp` | — | 9 | — | 29 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_encoder_group_add` | `engine/runtime_encoder_group_v2.cpp` | — | 9 | — | 27 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_hotkey_import` | `engine/runtime_hotkey_v2.cpp` | — | 9 | — | 27 | new cohesive helper/function in scoped file |
| `obs_engine::publish_deferred_source_snapshot` | `engine/runtime_source_v2.cpp` | 9 | 9 | 27 | 27 | unchanged |
| `Invoke-Task30Available` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 9 | — | 26 | new cohesive helper/function in scoped file |
...
| `obs_engine::collect_output_signal` | `engine/runtime_output_v2.cpp` | — | 9 | — | 25 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_recording_configure` | `engine/runtime_recording_v2.cpp` | — | 9 | — | 25 | new cohesive helper/function in scoped file |
...
| `Assert-Task30ColorCapture` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 9 | — | 21 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_meter_source_handles` | `engine/runtime_audio_v2.cpp` | — | 9 | — | 20 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_recording_path_options` | `engine/runtime_recording_v2.cpp` | — | 9 | — | 18 | new cohesive helper/function in scoped file |
| `Assert-Task29PhysicalFile` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 9 | — | 17 | new cohesive helper/function in scoped file |
| `obs_engine::collect_sensitive_recursive` | `engine/properties_sensitive.cpp` | 9 | 9 | 17 | 17 | unchanged |
| `obs_engine::read_encoder_create_options` | `engine/runtime_encoder_v2.cpp` | — | 9 | — | 17 | new cohesive helper/function in scoped file |
...
| `obs_engine::output_is_recording_compatible` | `engine/runtime_recording_v2.cpp` | — | 9 | — | 16 | new cohesive helper/function in scoped file |
...
| `obs_encoder_set_group` | `libobs/obs-encoder.c` | — | 8 | — | 40 | new cohesive helper/function in scoped file |
| `Invoke-Task27CreateAndConfigure` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 8 | — | 39 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_apply_virtual_camera_target` | `engine/runtime_virtual_camera_v2.cpp` | — | 8 | — | 38 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_audio_forget_source` | `engine/runtime_audio_v2.cpp` | — | 8 | — | 36 | new cohesive helper/function in scoped file |
| `obs_encoder_destroy` | `libobs/obs-encoder.c` | — | 8 | — | 36 | new cohesive helper/function in scoped file |
...
| `obs_engine::append_scalar_audio_event` | `engine/runtime_audio_v2.cpp` | — | 8 | — | 34 | new cohesive helper/function in scoped file |
...
| `obs_engine::handle_phase3_request` | `engine/protocol_phase3_v2.cpp` | — | 8 | — | 31 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_scene_remove` | `engine/runtime_scene_v2.cpp` | — | 8 | — | 31 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_create` | `engine/runtime_encoder_v2.cpp` | — | 8 | — | 30 | new cohesive helper/function in scoped file |
...
| `obs_engine::settle_pending_update` | `engine/runtime_encoder_v2.cpp` | — | 8 | — | 28 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_add_filter_observer` | `engine/runtime_filter_v2.cpp` | — | 8 | — | 28 | new cohesive helper/function in scoped file |
| `obs_engine::recording_file_changed_callback` | `engine/runtime_recording_v2.cpp` | — | 8 | — | 28 | new cohesive helper/function in scoped file |
| `obs_canvas_reset_video_internal` | `libobs/obs-canvas.c` | — | 8 | — | 28 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_set_monitoring_device` | `engine/runtime_audio_v2.cpp` | — | 8 | — | 27 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_roi_remove` | `engine/runtime_encoder_v2.cpp` | — | 8 | — | 27 | new cohesive helper/function in scoped file |
...
| `obs_engine::replay_saved_callback` | `engine/runtime_replay_buffer_v2.cpp` | — | 8 | — | 26 | new cohesive helper/function in scoped file |
...
| `Read-Task22Message` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 8 | — | 17 | new cohesive helper/function in scoped file |
...
| `obs_engine::protocol_supported` | `engine/runtime_streaming_v2.cpp` | — | 8 | — | 15 | new cohesive helper/function in scoped file |
| `Get-Task21Kinds` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 8 | — | 14 | new cohesive helper/function in scoped file |
...
| `obs_engine::parse_handle_text` | `engine/runtime_audio_v2.cpp` | — | 8 | — | 14 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_validate_recording_configuration` | `engine/runtime_recording_v2.cpp` | — | 8 | — | 13 | new cohesive helper/function in scoped file |
...
| `Assert-Task21StateEvent` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 8 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_registerer_type` | `engine/runtime_hotkey_v2.cpp` | — | 8 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_audio_subscribe_meters` | `engine/runtime_audio_v2.cpp` | — | 7 | — | 39 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_virtual_camera_get_capabilities` | `engine/runtime_virtual_camera_v2.cpp` | — | 7 | — | 35 | new cohesive helper/function in scoped file |
...
| `New-Task21Graph` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 7 | — | 31 | new cohesive helper/function in scoped file |
...
| `Invoke-Task30PhysicalColor` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 7 | — | 26 | new cohesive helper/function in scoped file |
...
| `Invoke-Task29SaveRace` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 7 | — | 24 | new cohesive helper/function in scoped file |
| `obs_engine::handle_session_method` | `engine/protocol_v2.cpp` | — | 7 | — | 24 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_set_scale_filter` | `engine/runtime_encoder_v2.cpp` | — | 7 | — | 24 | new cohesive helper/function in scoped file |
...
| `obs_engine::publish_audio_events` | `engine/runtime_audio_v2.cpp` | — | 7 | — | 23 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_remove` | `engine/runtime_encoder_v2.cpp` | — | 7 | — | 23 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_bindings` | `engine/runtime_hotkey_v2.cpp` | — | 7 | — | 20 | new cohesive helper/function in scoped file |
...
| `obs_engine::canonicalize_recording_path` | `engine/runtime_recording_v2.cpp` | — | 7 | — | 20 | new cohesive helper/function in scoped file |
...
| `Read-Task23Event` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 7 | — | 18 | new cohesive helper/function in scoped file |
...
| `obs_engine::prepare_recording_path_parent` | `engine/runtime_recording_v2.cpp` | — | 7 | — | 18 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_apply_recording_configuration_settings` | `engine/runtime_recording_v2.cpp` | — | 7 | — | 17 | new cohesive helper/function in scoped file |
...
| `obs_engine::audio_meter_callback` | `engine/runtime_audio_v2.cpp` | — | 7 | — | 16 | new cohesive helper/function in scoped file |
...
| `start_runtime` | `engine/task23_encoder_bridge_test.cpp` | — | 7 | — | 16 | new cohesive helper/function in scoped file |
...
| `Read-PhysicalEvent` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 7 | — | 14 | new cohesive helper/function in scoped file |
| `Read-Task28Event` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 7 | — | 14 | new cohesive helper/function in scoped file |
...
| `Read-PhysicalEvent` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 7 | — | 13 | new cohesive helper/function in scoped file |
| `Assert-PhysicalFile` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 7 | — | 13 | new cohesive helper/function in scoped file |
| `Read-Task27Event` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 7 | — | 13 | new cohesive helper/function in scoped file |
| `Read-Task29PhysicalEvent` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 7 | — | 13 | new cohesive helper/function in scoped file |
| `Read-Task29Event` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 7 | — | 13 | new cohesive helper/function in scoped file |
| `Read-Task30PhysicalEvent` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 7 | — | 13 | new cohesive helper/function in scoped file |
| `Read-Task30Event` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 7 | — | 13 | new cohesive helper/function in scoped file |
...
| `obs_engine::registerer_matches` | `engine/runtime_hotkey_v2.cpp` | — | 7 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::streaming_service_compatible` | `engine/runtime_streaming_v2.cpp` | — | 7 | — | 13 | new cohesive helper/function in scoped file |
...
| `Assert-Task22Event` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 7 | — | 12 | new cohesive helper/function in scoped file |
| `Read-Task25Event` | `.github/scripts/engine-protocol-v2-task25.ps1` | — | 7 | — | 12 | new cohesive helper/function in scoped file |
| `obs_engine::read_gating_fields` | `engine/runtime_audio_v2.cpp` | — | 7 | — | 12 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_virtual_target_object` | `engine/runtime_virtual_camera_v2.cpp` | — | 7 | — | 12 | new cohesive helper/function in scoped file |
| `Read-Task24Event` | `.github/scripts/engine-protocol-v2-task24.ps1` | — | 7 | — | 11 | new cohesive helper/function in scoped file |
...
| `Assert-FiniteMeter` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 7 | — | 9 | new cohesive helper/function in scoped file |
| `Invoke-Task25SecretChecks` | `.github/scripts/engine-protocol-v2-task25.ps1` | — | 7 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_output_state` | `engine/runtime_output_v2.cpp` | — | 6 | — | 43 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_prepare_shutdown` | `engine/runtime_source_v2.cpp` | 6 | 6 | 31 | 42 | unchanged |
...
| `obs_engine::Engine::v2_virtual_camera_unconfigure` | `engine/runtime_virtual_camera_v2.cpp` | — | 6 | — | 32 | new cohesive helper/function in scoped file |
...
| `remove_connection` | `libobs/obs-encoder.c` | — | 6 | — | 31 | new cohesive helper/function in scoped file |
...
| `Invoke-Task22AudioRoutingCheck` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 6 | — | 28 | new cohesive helper/function in scoped file |
...
| `obs_engine::get_registerer` | `engine/runtime_hotkey_v2.cpp` | — | 6 | — | 24 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_audio_set_monitoring_enabled` | `engine/runtime_audio_v2.cpp` | — | 6 | — | 23 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_canvas_list_scenes` | `engine/runtime_canvas_v2.cpp` | — | 6 | — | 23 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_prepare_encoder_shutdown` | `engine/runtime_encoder_v2.cpp` | — | 6 | — | 23 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_audio_set_sync_offset` | `engine/runtime_audio_v2.cpp` | — | 6 | — | 22 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_replay_buffer_unconfigure` | `engine/runtime_replay_buffer_v2.cpp` | — | 6 | — | 22 | new cohesive helper/function in scoped file |
...
| `obs_engine::resolve_single_hotkey` | `engine/runtime_hotkey_v2.cpp` | — | 6 | — | 20 | new cohesive helper/function in scoped file |
...
| `Invoke-Task29PhysicalReplay` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 6 | — | 19 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_forget_audio_hotkey` | `engine/runtime_hotkey_v2.cpp` | — | 6 | — | 19 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_append_recording_output_events` | `engine/runtime_recording_v2.cpp` | — | 6 | — | 19 | new cohesive helper/function in scoped file |
...
| `obs_engine::prepare_canvas_video_update` | `engine/runtime_canvas_v2.cpp` | — | 6 | — | 18 | new cohesive helper/function in scoped file |
| `obs_engine::read_binding_modifiers` | `engine/runtime_hotkey_v2.cpp` | — | 6 | — | 18 | new cohesive helper/function in scoped file |
...
| `obs_engine::create_private_source_media` | `engine/runtime_virtual_camera_v2.cpp` | — | 6 | — | 18 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_meter_subscription` | `engine/runtime_audio_v2.cpp` | — | 6 | — | 17 | new cohesive helper/function in scoped file |
| `obs_engine::replace_gating_event` | `engine/runtime_audio_v2.cpp` | — | 6 | — | 17 | new cohesive helper/function in scoped file |
| `obs_engine::read_canvas_flags` | `engine/runtime_canvas_v2.cpp` | — | 6 | — | 17 | new cohesive helper/function in scoped file |
| `obs_engine::take_hotkey_triggers` | `engine/runtime_hotkey_v2.cpp` | — | 6 | — | 17 | new cohesive helper/function in scoped file |
...
| `Invoke-Task27Lifecycle` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 6 | — | 16 | new cohesive helper/function in scoped file |
...
| `obs_engine::virtual_target_name` | `engine/runtime_virtual_camera_v2.cpp` | — | 6 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::parse_virtual_target_name` | `engine/runtime_virtual_camera_v2.cpp` | — | 6 | — | 16 | new cohesive helper/function in scoped file |
...
| `Invoke-Task29Configure` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 6 | — | 15 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_last_replay_path` | `engine/runtime_replay_buffer_v2.cpp` | — | 6 | — | 15 | new cohesive helper/function in scoped file |
...
| `Stop-Task21Engine` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 6 | — | 12 | new cohesive helper/function in scoped file |
| `Read-Task21Meter` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 6 | — | 12 | new cohesive helper/function in scoped file |
| `Stop-Task23Engine` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 6 | — | 12 | new cohesive helper/function in scoped file |
...
| `obs_engine::output_is_replay_compatible` | `engine/runtime_replay_buffer_v2.cpp` | — | 6 | — | 12 | new cohesive helper/function in scoped file |
...
| `Invoke-Task30Unavailable` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 6 | — | 11 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_requested_monitoring_device` | `engine/runtime_audio_v2.cpp` | — | 6 | — | 11 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_service_kind` | `engine/runtime_service_v2.cpp` | — | 6 | — | 10 | new cohesive helper/function in scoped file |
...
| `Stop-Task28PhysicalEngine` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 6 | — | 7 | new cohesive helper/function in scoped file |
| `Stop-Task28Engine` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 6 | — | 7 | new cohesive helper/function in scoped file |
...
| `Invoke-PhysicalRecording` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 5 | — | 32 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_hotkey_set_background_capture` | `engine/runtime_hotkey_v2.cpp` | — | 5 | — | 28 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_prepare_hotkey_shutdown` | `engine/runtime_hotkey_v2.cpp` | — | 5 | — | 25 | new cohesive helper/function in scoped file |
...
| `obs_engine::prepare` | `engine/protocol_phase3_v2.cpp` | — | 5 | — | 23 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_set_balance` | `engine/runtime_audio_v2.cpp` | — | 5 | — | 23 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_hotkey_get_conflicts` | `engine/runtime_hotkey_v2.cpp` | — | 5 | — | 23 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_recording_get_state` | `engine/runtime_recording_v2.cpp` | — | 5 | — | 23 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_audio_set_mute` | `engine/runtime_audio_v2.cpp` | — | 5 | — | 22 | new cohesive helper/function in scoped file |
| `obs_engine::make_encoder_summary` | `engine/runtime_encoder_v2.cpp` | — | 5 | — | 22 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_set_scaled_size` | `engine/runtime_encoder_v2.cpp` | — | 5 | — | 22 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_encoder_set_video_input` | `engine/runtime_encoder_v2.cpp` | — | 5 | — | 21 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_roi_add` | `engine/runtime_encoder_v2.cpp` | — | 5 | — | 21 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_sync_audio_observers` | `engine/runtime_audio_v2.cpp` | — | 5 | — | 20 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_codec_array` | `engine/runtime_service_v2.cpp` | — | 5 | — | 19 | new cohesive helper/function in scoped file |
...
| `schedule_encoder_reconfigure` | `libobs/obs-encoder.c` | — | 5 | — | 19 | new cohesive helper/function in scoped file |
...
| `obs_engine::hotkey_tick` | `engine/runtime_hotkey_v2.cpp` | — | 5 | — | 18 | new cohesive helper/function in scoped file |
...
| `Send-Task21` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 5 | — | 17 | new cohesive helper/function in scoped file |
| `Invoke-Task28Configure` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 5 | — | 17 | new cohesive helper/function in scoped file |
| `Invoke-Task29FailedSave` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 5 | — | 17 | new cohesive helper/function in scoped file |
...
| `Invoke-Task21DeviceChecks` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 5 | — | 16 | new cohesive helper/function in scoped file |
| `Assert-Task23Capabilities` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 5 | — | 16 | new cohesive helper/function in scoped file |
| `Start-Task28LoopbackReceiver` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 5 | — | 16 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_service_patch_settings` | `engine/runtime_service_v2.cpp` | — | 5 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_service_replace_settings` | `engine/runtime_service_v2.cpp` | — | 5 | — | 16 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_virtual_camera_set_target` | `engine/runtime_virtual_camera_v2.cpp` | — | 5 | — | 15 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_encoder_name_and_settings` | `engine/runtime_encoder_v2.cpp` | — | 5 | — | 14 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_read_virtual_camera_target` | `engine/runtime_virtual_camera_v2.cpp` | — | 5 | — | 14 | new cohesive helper/function in scoped file |
...
| `obs_engine::output_role_error` | `engine/runtime_output_v2.cpp` | — | 5 | — | 13 | new cohesive helper/function in scoped file |
...
| `obs_engine::bind_virtual_canvas_media` | `engine/runtime_virtual_camera_v2.cpp` | — | 5 | — | 13 | new cohesive helper/function in scoped file |
| `obs_module_unload` | `engine/task22_hotkey_plugin.cpp` | — | 5 | — | 13 | new cohesive helper/function in scoped file |
...
| `obs_engine::virtual_target_source` | `engine/runtime_virtual_camera_v2.cpp` | — | 5 | — | 11 | new cohesive helper/function in scoped file |
| `Test-ExceptionIdentity` | `tools/check-complexity.ps1` | — | 5 | — | 11 | new cohesive helper/function in scoped file |
| `Read-Task21Event` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 5 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_meter_source_item` | `engine/runtime_audio_v2.cpp` | — | 5 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::read_roi_coordinate` | `engine/runtime_encoder_v2.cpp` | — | 5 | — | 10 | new cohesive helper/function in scoped file |
...
| `Send-Task27Physical` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
| `Send-Task27` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
| `Send-Task28Physical` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
| `Send-Task28` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
| `Send-Task29Physical` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
| `Send-Task29` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
| `Send-Task30Physical` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
| `Send-Task30` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::fill_output_registerer` | `engine/runtime_hotkey_v2.cpp` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::fill_encoder_registerer` | `engine/runtime_hotkey_v2.cpp` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::fill_service_registerer` | `engine/runtime_hotkey_v2.cpp` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_scene_remove_blocked` | `engine/runtime_scene_v2.cpp` | — | 5 | — | 9 | new cohesive helper/function in scoped file |
...
| `Assert-PhysicalFiles` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 5 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::validate_recording_path_text` | `engine/runtime_recording_v2.cpp` | — | 5 | — | 8 | new cohesive helper/function in scoped file |
...
| `Stop-Task27PhysicalEngine` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 5 | — | 6 | new cohesive helper/function in scoped file |
| `Stop-Task27Engine` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 5 | — | 6 | new cohesive helper/function in scoped file |
| `Assert-Error` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 5 | — | 6 | new cohesive helper/function in scoped file |
| `Stop-Task29PhysicalEngine` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 5 | — | 6 | new cohesive helper/function in scoped file |
| `Stop-Task29Engine` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 5 | — | 6 | new cohesive helper/function in scoped file |
| `Stop-Task30PhysicalEngine` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 5 | — | 6 | new cohesive helper/function in scoped file |
| `Stop-Task30Engine` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 5 | — | 6 | new cohesive helper/function in scoped file |
...
| `Assert-PhysicalOk` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 5 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::canvas_video_options_equal` | `engine/runtime_canvas_v2.cpp` | — | 5 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::start_runtime` | `engine/runtime.cpp` | — | 5 | — | 5 | new cohesive helper/function in scoped file |
...
| `Assert-Error` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 5 | — | 4 | new cohesive helper/function in scoped file |
| `Assert-Error` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 5 | — | 4 | new cohesive helper/function in scoped file |
| `Assert-Error` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 5 | — | 4 | new cohesive helper/function in scoped file |
| `Assert-ErrorAtOrAfter` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 5 | — | 4 | new cohesive helper/function in scoped file |
...
| `Start-Task21Engine` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 4 | — | 27 | new cohesive helper/function in scoped file |
| `obs_engine::make_audio_data` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 27 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_interaction_key` | `engine/runtime_interaction_v2.cpp` | 22 | 4 | 64 | 27 | reduced by 18 |
| `Invoke-Task21VolumeChecks` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 4 | — | 26 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_set_push_to_talk` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 26 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_set_push_to_mute` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 26 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_replay_buffer_get_state` | `engine/runtime_replay_buffer_v2.cpp` | — | 4 | — | 24 | new cohesive helper/function in scoped file |
...
| `obs_engine::disconnect_audio_observer` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 22 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_encoder_group_create` | `engine/runtime_encoder_group_v2.cpp` | — | 4 | — | 21 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_encoder_group_list` | `engine/runtime_encoder_group_v2.cpp` | — | 4 | — | 20 | new cohesive helper/function in scoped file |
...
| `create_test_pipeline` | `engine/task23_encoder_bridge_test.cpp` | — | 4 | — | 20 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_service_kind_data` | `engine/runtime_service_v2.cpp` | — | 4 | — | 19 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_audio_set_volume` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 18 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_group_remove` | `engine/runtime_encoder_group_v2.cpp` | — | 4 | — | 18 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_kind_properties` | `engine/runtime_encoder_v2.cpp` | — | 4 | — | 18 | new cohesive helper/function in scoped file |
| `obs_engine::enumerate_hotkey` | `engine/runtime_hotkey_v2.cpp` | — | 4 | — | 18 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::register_scene_entry` | `engine/runtime_scene_v2.cpp` | — | 4 | — | 18 | new cohesive helper/function in scoped file |
| `obs_engine::make_service_summary` | `engine/runtime_service_v2.cpp` | — | 4 | — | 18 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_service_remove` | `engine/runtime_service_v2.cpp` | — | 4 | — | 18 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_virtual_camera_get_state` | `engine/runtime_virtual_camera_v2.cpp` | — | 4 | — | 18 | new cohesive helper/function in scoped file |
| `Invoke-AfterMode` | `tools/check-complexity.ps1` | — | 4 | — | 18 | new cohesive helper/function in scoped file |
| `Initialize-Task27Session` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 4 | — | 17 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_string_field` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 17 | new cohesive helper/function in scoped file |
| `obs_engine::read_string_field` | `engine/runtime_filter_v2.cpp` | 4 | 4 | 17 | 17 | unchanged |
| `obs_engine::read_string_field` | `engine/runtime_hotkey_v2.cpp` | — | 4 | — | 17 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_recording_unconfigure` | `engine/runtime_recording_v2.cpp` | — | 4 | — | 17 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_integer_field` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::collect_audio_signal` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 16 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_hotkey_get_key_name` | `engine/runtime_hotkey_v2.cpp` | — | 4 | — | 16 | new cohesive helper/function in scoped file |
...
| `obs_encoder_remove_roi` | `libobs/obs-encoder.c` | — | 4 | — | 16 | new cohesive helper/function in scoped file |
...
| `Start-Task27Engine` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
| `Start-Task28Engine` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
| `Initialize-Task28Session` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
| `Start-Task29Engine` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
...
| `obs_engine::queue_deferred_audio_events_locked` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
| `obs_engine::read_canvas_flag` | `engine/runtime_canvas_v2.cpp` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
| `obs_engine::get_hotkey_snapshots` | `engine/runtime_hotkey_v2.cpp` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
...
| `obs_engine::service_has_stream_credential` | `engine/runtime_streaming_v2.cpp` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
| `obs_engine::make_streaming_service_params` | `engine/runtime_streaming_v2.cpp` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
...
| `obs_module_load` | `engine/task22_hotkey_plugin.cpp` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
| `record_source_update_range_locked` | `libobs/obs-source.c` | — | 4 | — | 15 | new cohesive helper/function in scoped file |
| `Complete-Task25` | `.github/scripts/engine-protocol-v2-task25.ps1` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
| `Initialize-Task29Session` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
| `obs_engine::commit_filter_result` | `engine/protocol_filter_v2.cpp` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
| `obs_engine::commit_phase3_result` | `engine/protocol_phase3_v2.cpp` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
| `obs_engine::commit_runtime_result` | `engine/protocol_v2.cpp` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
| `obs_engine::commit_direct_audio_event_locked` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
| `obs_engine::collect_audio_meter_sources` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_recording_get_stats` | `engine/runtime_recording_v2.cpp` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
...
| `obs_engine::fail_phase3_request` | `engine/protocol_phase3_v2.cpp` | — | 4 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::read_canvas_device_fields` | `engine/runtime_canvas_v2.cpp` | — | 4 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_patch_settings` | `engine/runtime_encoder_v2.cpp` | — | 4 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_replace_settings` | `engine/runtime_encoder_v2.cpp` | — | 4 | — | 13 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_libobs_binding_array` | `engine/runtime_hotkey_v2.cpp` | — | 4 | — | 13 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_replay_buffer_get_stats` | `engine/runtime_replay_buffer_v2.cpp` | — | 4 | — | 13 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_virtual_target_data` | `engine/runtime_virtual_camera_v2.cpp` | — | 4 | — | 13 | new cohesive helper/function in scoped file |
...
| `Initialize-Task29PhysicalSession` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 4 | — | 12 | new cohesive helper/function in scoped file |
| `Start-Task30Consumer` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 4 | — | 12 | new cohesive helper/function in scoped file |
...
| `Initialize-Task30Session` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 4 | — | 11 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_get_encoder_group_entry` | `engine/runtime_encoder_group_v2.cpp` | — | 4 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_get_encoder_entry` | `engine/runtime_encoder_v2.cpp` | — | 4 | — | 11 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_get_recording_output` | `engine/runtime_recording_v2.cpp` | — | 4 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::replay_file_size` | `engine/runtime_replay_buffer_v2.cpp` | — | 4 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_get_replay_buffer_output` | `engine/runtime_replay_buffer_v2.cpp` | — | 4 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::make_service_candidate` | `engine/runtime_service_v2.cpp` | — | 4 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_get_service_entry` | `engine/runtime_service_v2.cpp` | — | 4 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_get_streaming_output` | `engine/runtime_streaming_v2.cpp` | — | 4 | — | 11 | new cohesive helper/function in scoped file |
...
| `Initialize-Task28PhysicalSession` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 4 | — | 10 | new cohesive helper/function in scoped file |
| `Initialize-Task30PhysicalSession` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 4 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::virtual_target_handle_field` | `engine/runtime_virtual_camera_v2.cpp` | — | 4 | — | 10 | new cohesive helper/function in scoped file |
...
| `Wait-Task21StereoLayout` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
| `Initialize-Task24Session` | `.github/scripts/engine-protocol-v2-task24.ps1` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
| `Initialize-Task25Session` | `.github/scripts/engine-protocol-v2-task25.ps1` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::result_has_source_event` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::encoder_kind_exists` | `engine/runtime_encoder_v2.cpp` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::make_encoder_candidate` | `engine/runtime_encoder_v2.cpp` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_optional_string` | `engine/runtime_hotkey_v2.cpp` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::find_hotkeys` | `engine/runtime_hotkey_v2.cpp` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_read_preview_scene_request` | `engine/runtime_preview_v2.cpp` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_prepare_recording_shutdown` | `engine/runtime_recording_v2.cpp` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_prepare_replay_shutdown` | `engine/runtime_replay_buffer_v2.cpp` | — | 4 | — | 9 | new cohesive helper/function in scoped file |
...
| `Read-Task22Event` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 4 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_monitoring_device_data` | `engine/runtime_audio_v2.cpp` | — | 4 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::require_inactive_video_encoder` | `engine/runtime_encoder_v2.cpp` | — | 4 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::read_registerer_metadata` | `engine/runtime_hotkey_v2.cpp` | — | 4 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::dangerous_replay_path` | `engine/runtime_replay_buffer_v2.cpp` | — | 4 | — | 8 | new cohesive helper/function in scoped file |
...
| `Read-Task27PhysicalMessage` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
| `Read-Task27Message` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
| `Read-Task28PhysicalMessage` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
| `Read-Task28Message` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
| `Read-Task29PhysicalMessage` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
| `Read-Task29Message` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
| `Invoke-Task29Save` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
| `Read-Task30PhysicalMessage` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
| `Read-Task30Message` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::value_is_present` | `engine/runtime_service_v2.cpp` | — | 4 | — | 7 | new cohesive helper/function in scoped file |
...
| `Stop-Task28LoopbackReceiver` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 4 | — | 6 | new cohesive helper/function in scoped file |
...
| `Wait-Task30Consumer` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 4 | — | 6 | new cohesive helper/function in scoped file |
| `Assert-OkAtOrAfter` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 4 | — | 6 | new cohesive helper/function in scoped file |
...
| `Assert-Error` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 4 | — | 5 | new cohesive helper/function in scoped file |
| `Assert-Error` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 4 | — | 5 | new cohesive helper/function in scoped file |
| `Assert-Error` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 4 | — | 5 | new cohesive helper/function in scoped file |
...
| `Assert-Ok` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 4 | — | 4 | new cohesive helper/function in scoped file |
...
| `Assert-Error` | `.github/scripts/engine-protocol-v2-task24.ps1` | — | 4 | — | 3 | new cohesive helper/function in scoped file |
...
| `Invoke-Task21Cleanup` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 3 | — | 32 | new cohesive helper/function in scoped file |
| `Invoke-Task28PhysicalStream` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 3 | — | 32 | new cohesive helper/function in scoped file |
...
| `Start-Task23Engine` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 3 | — | 22 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_service_kind_defaults` | `engine/runtime_service_v2.cpp` | — | 3 | — | 21 | new cohesive helper/function in scoped file |
...
| `obs_engine::attach_meter_source` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 20 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_set_tracks` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 20 | new cohesive helper/function in scoped file |
| `obs_engine::remove_filter_observer` | `engine/runtime_filter_v2.cpp` | 3 | 3 | 20 | 20 | unchanged |
| `obs_engine::Engine::v2_service_get_properties` | `engine/runtime_service_v2.cpp` | — | 3 | — | 20 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_audio_list_monitoring_devices` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 19 | new cohesive helper/function in scoped file |
...
| `obs_engine::register_pending_update` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 18 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_get_properties` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 18 | new cohesive helper/function in scoped file |
...
| `Invoke-Task28Cleanup` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_bool_field` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::read_object_field` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::read_array_field` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::find_monitoring_device` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
...
| `obs_engine::submit_encoder_update` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_list` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_bool_field` | `engine/runtime_hotkey_v2.cpp` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::read_object_field` | `engine/runtime_hotkey_v2.cpp` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::read_array_field` | `engine/runtime_hotkey_v2.cpp` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
...
| `Invoke-Task22KeyNameChecks` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 3 | — | 15 | new cohesive helper/function in scoped file |
| `Invoke-Task28PhysicalCleanup` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 3 | — | 15 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_encoder_kind_defaults` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 15 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_get_video_input` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 15 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_recording_get_current_path` | `engine/runtime_recording_v2.cpp` | — | 3 | — | 15 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_recording_get_last_file` | `engine/runtime_recording_v2.cpp` | — | 3 | — | 15 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_replay_buffer_get_last_file` | `engine/runtime_replay_buffer_v2.cpp` | — | 3 | — | 15 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_service_list` | `engine/runtime_service_v2.cpp` | — | 3 | — | 15 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_streaming_unconfigure` | `engine/runtime_streaming_v2.cpp` | — | 3 | — | 15 | new cohesive helper/function in scoped file |
...
| `Start-Task24Engine` | `.github/scripts/engine-protocol-v2-task24.ps1` | — | 3 | — | 14 | new cohesive helper/function in scoped file |
| `Start-Task27PhysicalEngine` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 3 | — | 14 | new cohesive helper/function in scoped file |
| `Start-Task28PhysicalEngine` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 3 | — | 14 | new cohesive helper/function in scoped file |
| `Start-Task29PhysicalEngine` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 3 | — | 14 | new cohesive helper/function in scoped file |
| `Invoke-Task29Cleanup` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 3 | — | 14 | new cohesive helper/function in scoped file |
| `Start-Task30PhysicalEngine` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 3 | — | 14 | new cohesive helper/function in scoped file |
| `Start-Task30Engine` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 3 | — | 14 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_recording_filesystem_path` | `engine/runtime_recording_v2.cpp` | — | 3 | — | 13 | new cohesive helper/function in scoped file |
...
| `Invoke-Task23Audio` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 3 | — | 12 | new cohesive helper/function in scoped file |
| `Start-Task25Engine` | `.github/scripts/engine-protocol-v2-task25.ps1` | — | 3 | — | 12 | new cohesive helper/function in scoped file |
...
| `obs_engine::set_tracks` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 12 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_roi_list` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 12 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_streaming_set_service` | `engine/runtime_streaming_v2.cpp` | — | 3 | — | 12 | new cohesive helper/function in scoped file |
...
| `Complete-Task23` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 3 | — | 11 | new cohesive helper/function in scoped file |
...
| `obs_engine::validate_mutation_guard` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 11 | new cohesive helper/function in scoped file |
...
| `obs_engine::take_due_meter_sources` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::discard_completed_updates` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 11 | new cohesive helper/function in scoped file |
...
| `obs_engine::release_virtual_target_media` | `engine/runtime_virtual_camera_v2.cpp` | — | 3 | — | 11 | new cohesive helper/function in scoped file |
...
| `Invoke-Task21MeterChecks` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 3 | — | 10 | new cohesive helper/function in scoped file |
| `Assert-Task22Capabilities` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 3 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_volume_data` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_begin_audio_event_capture` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::validate_encoder_candidate` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::validate_service_candidate` | `engine/runtime_service_v2.cpp` | — | 3 | — | 10 | new cohesive helper/function in scoped file |
...
| `wait_for` | `engine/task23_encoder_bridge_test.cpp` | — | 3 | — | 10 | new cohesive helper/function in scoped file |
...
| `Read-Task21SequencedEvent` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `Assert-Task21Capabilities` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `Read-Task22SequencedEvent` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `Invoke-Task23Roi` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `Invoke-Task25KindChecks` | `.github/scripts/engine-protocol-v2-task25.ps1` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `Initialize-Task9Session` | `.github/scripts/engine-protocol-v2-task9.ps1` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::volume_db` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::AudioCallbackScope::~AudioCallbackScope` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::update_volume_audio_observer` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_get_audio_source` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_wait_for_audio_event_callbacks` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::read_canvas_target_type` | `engine/runtime_canvas_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::encoder_input_dimensions` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_registerer` | `engine/runtime_hotkey_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::RecordingCallbackScope::~RecordingCallbackScope` | `engine/runtime_recording_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::ReplayCallbackScope::~ReplayCallbackScope` | `engine/runtime_replay_buffer_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_streaming_start` | `engine/runtime_streaming_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_virtual_target_handle` | `engine/runtime_virtual_camera_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::create_private_target_media` | `engine/runtime_virtual_camera_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_virtual_camera_start` | `engine/runtime_virtual_camera_v2.cpp` | — | 3 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::classify` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::classify_hotkey` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::classify_recording` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::classify_streaming` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::classify_replay_buffer` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::classify_virtual_camera` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::is_mutating` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::is_mutating` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::handler_for` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::hotkey_handler_for` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::recording_handler_for` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::streaming_handler_for` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::replay_buffer_handler_for` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::virtual_camera_handler_for` | `engine/protocol_phase3_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::remove_pending_update` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::find_modifier` | `engine/runtime_hotkey_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::is_dangerous_recording_path` | `engine/runtime_recording_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_virtual_camera_output_idle` | `engine/runtime_virtual_camera_v2.cpp` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `obs_service_get_protocol` | `libobs/obs-service.c` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `Invoke-ComplexityRun` | `tools/check-complexity.ps1` | — | 3 | — | 8 | new cohesive helper/function in scoped file |
| `Invoke-Task30PhysicalSetup` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 3 | — | 7 | new cohesive helper/function in scoped file |
| `Close-Task30Session` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 3 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_encoder_handle_for_pointer` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 7 | new cohesive helper/function in scoped file |
| `obs_engine::clone_data` | `engine/runtime_filter_v2.cpp` | 3 | 3 | 7 | 7 | unchanged |
| `obs_engine::find_hotkey_by_id` | `engine/runtime_hotkey_v2.cpp` | — | 3 | — | 7 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_hotkey_toggle_audio_mute` | `engine/runtime_hotkey_v2.cpp` | — | 3 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::streaming_output_compatible` | `engine/runtime_streaming_v2.cpp` | — | 3 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::fail` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::read_handle_field` | `engine/runtime_audio_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::fail` | `engine/runtime_encoder_group_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::fail` | `engine/runtime_encoder_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::fail` | `engine/runtime_hotkey_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::fail` | `engine/runtime_recording_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::fail` | `engine/runtime_replay_buffer_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::fail` | `engine/runtime_service_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::fail` | `engine/runtime_streaming_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::fail` | `engine/runtime_v2.cpp` | 3 | 3 | 6 | 6 | unchanged |
| `obs_engine::fail` | `engine/runtime_virtual_camera_v2.cpp` | — | 3 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::output_has_other_convenience_role` | `engine/runtime_replay_buffer_v2.cpp` | — | 3 | — | 5 | new cohesive helper/function in scoped file |
...
| `Assert-Ok` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 3 | — | 4 | new cohesive helper/function in scoped file |
| `Assert-Ok` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 3 | — | 4 | new cohesive helper/function in scoped file |
| `Assert-Ok` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 3 | — | 4 | new cohesive helper/function in scoped file |
| `Assert-Ok` | `.github/scripts/engine-protocol-v2-task24.ps1` | — | 3 | — | 4 | new cohesive helper/function in scoped file |
| `Assert-PhysicalOk` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 3 | — | 4 | new cohesive helper/function in scoped file |
| `Assert-Ok` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 3 | — | 4 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_virtual_camera_target_in_use` | `engine/runtime_virtual_camera_v2.cpp` | — | 3 | — | 4 | new cohesive helper/function in scoped file |
...
| `Assert-PhysicalOk` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 3 | — | 3 | new cohesive helper/function in scoped file |
| `Assert-Ok` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 3 | — | 3 | new cohesive helper/function in scoped file |
| `Assert-PhysicalOk` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 3 | — | 3 | new cohesive helper/function in scoped file |
| `Assert-Ok` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 3 | — | 3 | new cohesive helper/function in scoped file |
...
| `Initialize-Task22Session` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 2 | — | 27 | new cohesive helper/function in scoped file |
...
| `obs_engine::classify_phase3` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 26 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_roi_list` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 23 | new cohesive helper/function in scoped file |
...
| `Invoke-Task27StopAndCleanup` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 2 | — | 22 | new cohesive helper/function in scoped file |
...
| `Invoke-Task30PhysicalCleanup` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 2 | — | 20 | new cohesive helper/function in scoped file |
...
| `Invoke-Task22TriggerChecks` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 2 | — | 19 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_virtual_camera_get_target` | `engine/runtime_virtual_camera_v2.cpp` | — | 2 | — | 17 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_audio_toggle_mute` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_get_push_to_talk` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 16 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_get_push_to_mute` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 16 | new cohesive helper/function in scoped file |
...
| `Initialize-Task21Session` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 2 | — | 15 | new cohesive helper/function in scoped file |
| `Invoke-Task25ServiceReads` | `.github/scripts/engine-protocol-v2-task25.ps1` | — | 2 | — | 15 | new cohesive helper/function in scoped file |
...
| `Invoke-Task28Lifecycle` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 2 | — | 14 | new cohesive helper/function in scoped file |
...
| `obs_engine::disconnect_replay_observer` | `engine/runtime_replay_buffer_v2.cpp` | — | 2 | — | 14 | new cohesive helper/function in scoped file |
...
| `Invoke-PhysicalCleanup` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_get_monitoring_enabled` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_get_tracks` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::tracked_encoder_update` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_get_codec` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_get_type` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_filter_kind_properties` | `engine/runtime_filter_v2.cpp` | 5 | 2 | 17 | 13 | reduced by 3 |
| `obs_engine::Engine::v2_hotkey_get_bindings` | `engine/runtime_hotkey_v2.cpp` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_service_get_supported_audio_codecs` | `engine/runtime_service_v2.cpp` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_service_can_connect` | `engine/runtime_service_v2.cpp` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_virtual_config` | `engine/runtime_virtual_camera_v2.cpp` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
| `Assert-ExactJsonShape` | `tools/check-complexity.ps1` | — | 2 | — | 13 | new cohesive helper/function in scoped file |
| `Invoke-Task23ObjectReads` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 2 | — | 12 | new cohesive helper/function in scoped file |
| `Invoke-Task29PhysicalCleanup` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 2 | — | 12 | new cohesive helper/function in scoped file |
| `obs_engine::set_bound_outputs` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 12 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_kind_capabilities` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 12 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_hotkey_get_key_combination_name` | `engine/runtime_hotkey_v2.cpp` | — | 2 | — | 12 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_recording_file_event` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 12 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_streaming_get_state` | `engine/runtime_streaming_v2.cpp` | — | 2 | — | 12 | new cohesive helper/function in scoped file |
...
| `obs_engine::execute_audio` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::execute_hotkey` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
...
| `obs_engine::execute_recording` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::execute_streaming` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::execute_replay_buffer` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::execute_virtual_camera` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_recording_pause` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_recording_resume` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_recording_toggle_pause` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::make_replay_save_result` | `engine/runtime_replay_buffer_v2.cpp` | — | 2 | — | 11 | new cohesive helper/function in scoped file |
...
| `Initialize-Task27PhysicalSession` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_get` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_audio_get_volume` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_encoder_group_get` | `engine/runtime_encoder_group_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_get` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_get_settings` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_get_state` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::append_filter_rename_event` | `engine/runtime_filter_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::publish_hotkey_trigger` | `engine/runtime_hotkey_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_recording_config` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::make_recording_path_result` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::make_replay_filesystem_path` | `engine/runtime_replay_buffer_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::make_replay_config` | `engine/runtime_replay_buffer_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `obs_engine::make_replay_path_result` | `engine/runtime_replay_buffer_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_streaming_config` | `engine/runtime_streaming_v2.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
...
| `load_test_modules` | `engine/task23_encoder_bridge_test.cpp` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::update_balance_audio_observer` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_canvas_get_main` | `engine/runtime_canvas_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::make_video_input` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::make_encoder_settings_result` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_bind_encoder_events` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_encoder_kind_get` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_binding_array` | `engine/runtime_hotkey_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_recording_start` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_recording_stop` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_recording_force_stop` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::make_replay_saved_event` | `engine/runtime_replay_buffer_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_replay_buffer_start` | `engine/runtime_replay_buffer_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_replay_buffer_stop` | `engine/runtime_replay_buffer_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_streaming_stop` | `engine/runtime_streaming_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_streaming_force_stop` | `engine/runtime_streaming_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_streaming_get_stats` | `engine/runtime_streaming_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_streaming_get_service` | `engine/runtime_streaming_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_streaming_get_reconnect_state` | `engine/runtime_streaming_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_streaming_get_last_error` | `engine/runtime_streaming_v2.cpp` | — | 2 | — | 9 | new cohesive helper/function in scoped file |
...
| `Read-Task21NextEvent` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 2 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::reject_read_guard` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::AudioMeterSource::AudioMeterSource` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::key_combination_name` | `engine/runtime_hotkey_v2.cpp` | — | 2 | — | 8 | new cohesive helper/function in scoped file |
...
| `obs_engine::RecordingCallbackScope::RecordingCallbackScope` | `engine/runtime_recording_v2.cpp` | — | 2 | — | 8 | new cohesive helper/function in scoped file |
| `obs_engine::ReplayCallbackScope::ReplayCallbackScope` | `engine/runtime_replay_buffer_v2.cpp` | — | 2 | — | 8 | new cohesive helper/function in scoped file |
...
| `Invoke-PhysicalMutation` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `Invoke-Task27Mutation` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `Invoke-Task28PhysicalMutation` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `Invoke-Task28Mutation` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `Invoke-Task29PhysicalMutation` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `Invoke-Task29Mutation` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `Invoke-Task30PhysicalMutation` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `Invoke-Task30Mutation` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::Phase3CaptureScope::flush` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::set_nullable_group` | `engine/runtime_encoder_group_v2.cpp` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `obs_engine::create_encoder` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `obs_engine::set_nullable_handle` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `obs_engine::hotkey_router_callback` | `engine/runtime_hotkey_v2.cpp` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::read_virtual_target` | `engine/runtime_virtual_camera_v2.cpp` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_virtual_camera_stop` | `engine/runtime_virtual_camera_v2.cpp` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
| `update_inactive_encoder` | `libobs/obs-encoder.c` | — | 2 | — | 7 | new cohesive helper/function in scoped file |
...
| `Request` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 2 | — | 6 | new cohesive helper/function in scoped file |
| `Invoke-Task29Lifecycle` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 2 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::binding_less` | `engine/runtime_hotkey_v2.cpp` | — | 2 | — | 6 | new cohesive helper/function in scoped file |
...
| `apply_encoder_settings` | `libobs/obs-encoder.c` | — | 2 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::Phase3CaptureScope::~Phase3CaptureScope` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::publish_events` | `engine/protocol_phase3_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::update_audio_observer` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::detach_meter_sources` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_drain_deferred_audio_events` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_flush_deferred_audio_events` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::ObsPropertiesDeleter::operator ( )` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::encoder_settings` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_publish_output_callback_events` | `engine/runtime_output_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::ObsPropertiesDeleter::operator ( )` | `engine/runtime_service_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::collect_property_secrets` | `engine/runtime_service_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::erase_requested_secrets` | `engine/runtime_service_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::bind_virtual_program_media` | `engine/runtime_virtual_camera_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::virtual_camera_output_registered` | `engine/runtime_virtual_camera_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_virtual_camera_scene_target_in_use` | `engine/runtime_virtual_camera_v2.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
| `DataDeleter::operator ( )` | `engine/task23_encoder_bridge_test.cpp` | — | 2 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::is_audio_source` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 4 | new cohesive helper/function in scoped file |
| `obs_engine::read_meter_request` | `engine/runtime_audio_v2.cpp` | — | 2 | — | 4 | new cohesive helper/function in scoped file |
| `obs_engine::encoder_type_name` | `engine/runtime_encoder_v2.cpp` | — | 2 | — | 4 | new cohesive helper/function in scoped file |
...
| `Assert-NoSentinel` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 2 | — | 3 | new cohesive helper/function in scoped file |
| `Assert-NoSentinel` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 2 | — | 3 | new cohesive helper/function in scoped file |
...
| `Invoke-PhysicalSetup` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 1 | — | 22 | new cohesive helper/function in scoped file |
...
| `obs_engine::create_audio_observer` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 19 | new cohesive helper/function in scoped file |
...
| `reset_video` | `engine/task23_encoder_bridge_test.cpp` | — | 1 | — | 16 | new cohesive helper/function in scoped file |
...
| `Invoke-Task29PhysicalSetup` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 1 | — | 14 | new cohesive helper/function in scoped file |
| `obs_engine::print_help` | `engine/config.cpp` | 1 | 1 | 14 | 14 | unchanged |
| `obs_engine::make_gating_data` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 14 | new cohesive helper/function in scoped file |
| `obs_engine::connect_audio_observer` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 14 | new cohesive helper/function in scoped file |
| `obs_engine::make_encoder_capabilities` | `engine/runtime_encoder_v2.cpp` | — | 1 | — | 14 | new cohesive helper/function in scoped file |
...
| `Invoke-Task21RestrictionChecks` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 1 | — | 13 | new cohesive helper/function in scoped file |
...
| `Invoke-Task21Scenario` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 1 | — | 12 | new cohesive helper/function in scoped file |
| `Run-CaseA` | `.github/scripts/engine-protocol-v2-task8-concurrency.ps1` | 1 | 1 | 12 | 12 | unchanged |
| `obs_engine::read_service_settings` | `engine/runtime_service_v2.cpp` | — | 1 | — | 12 | new cohesive helper/function in scoped file |
| `Invoke-Task28PhysicalSetup` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 1 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::disconnect_recording_observer` | `engine/runtime_recording_v2.cpp` | — | 1 | — | 11 | new cohesive helper/function in scoped file |
| `obs_engine::connect_observer` | `engine/runtime_source_v2.cpp` | 1 | 1 | 11 | 11 | unchanged |
| `update_callback` | `engine/task23_encoder_bridge_test.cpp` | — | 1 | — | 11 | new cohesive helper/function in scoped file |
...
| `Invoke-Task29Create` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 1 | — | 10 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_register_recording_role` | `engine/runtime_recording_v2.cpp` | — | 1 | — | 9 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_prepare_virtual_camera_shutdown` | `engine/runtime_virtual_camera_v2.cpp` | — | 1 | — | 8 | new cohesive helper/function in scoped file |
...
| `Invoke-Task28Create` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 1 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::set_cached_delay` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 7 | new cohesive helper/function in scoped file |
| `obs_engine::make_encoder_group_change` | `engine/runtime_encoder_group_v2.cpp` | — | 1 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_hotkey_identity_data` | `engine/runtime_hotkey_v2.cpp` | — | 1 | — | 7 | new cohesive helper/function in scoped file |
| `obs_engine::make_binding_changed_data` | `engine/runtime_hotkey_v2.cpp` | — | 1 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_engine::make_recording_finalized_event` | `engine/runtime_recording_v2.cpp` | — | 1 | — | 7 | new cohesive helper/function in scoped file |
...
| `obs_module_load` | `engine/task21_audio_source.cpp` | — | 1 | — | 7 | new cohesive helper/function in scoped file |
| `reset_audio` | `engine/task23_encoder_bridge_test.cpp` | — | 1 | — | 7 | new cohesive helper/function in scoped file |
| `obs_module_load` | `engine/task23_encoder_plugin.cpp` | — | 1 | — | 7 | new cohesive helper/function in scoped file |
...
| `Invoke-Task23Scaling` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::clear_deferred_audio_events` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::set_cached_bool` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::steady_now_ns` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::append_group_mutation_events` | `engine/runtime_encoder_group_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::recording_output_params` | `engine/runtime_recording_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_recording_get_config` | `engine/runtime_recording_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::replay_output_params` | `engine/runtime_replay_buffer_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_replay_buffer_get_config` | `engine/runtime_replay_buffer_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::streaming_output_params` | `engine/runtime_streaming_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::Engine::v2_streaming_get_config` | `engine/runtime_streaming_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
| `obs_engine::virtual_output_params` | `engine/runtime_virtual_camera_v2.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_module_load` | `engine/task27_recording_plugin.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
| `obs_module_load` | `engine/task29_replay_plugin.cpp` | — | 1 | — | 6 | new cohesive helper/function in scoped file |
...
| `obs_engine::Phase3CaptureScope::Phase3CaptureScope` | `engine/protocol_phase3_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::reset_result` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::set_handle` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::read_audio_source` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::reset_result` | `engine/runtime_encoder_group_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::reset_result` | `engine/runtime_encoder_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::reset_result` | `engine/runtime_hotkey_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::normalize_bindings` | `engine/runtime_hotkey_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::reset_result` | `engine/runtime_recording_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::path_to_utf8` | `engine/runtime_recording_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::connect_recording_observer` | `engine/runtime_recording_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::reset_result` | `engine/runtime_replay_buffer_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::replay_path_to_utf8` | `engine/runtime_replay_buffer_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::connect_replay_observer` | `engine/runtime_replay_buffer_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `obs_engine::reset_result` | `engine/runtime_service_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::reset_result` | `engine/runtime_streaming_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::reset_result` | `engine/runtime_virtual_camera_v2.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
...
| `wait_for_update` | `engine/task23_encoder_bridge_test.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
| `stop_test_output` | `engine/task23_encoder_bridge_test.cpp` | — | 1 | — | 5 | new cohesive helper/function in scoped file |
...
| `obs_engine::append_event` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 4 | new cohesive helper/function in scoped file |
| `obs_engine::finite_float` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 4 | new cohesive helper/function in scoped file |
...
| `obs_engine::append_event` | `engine/runtime_hotkey_v2.cpp` | — | 1 | — | 4 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_output_is_inactive` | `engine/runtime_output_v2.cpp` | — | 1 | — | 4 | new cohesive helper/function in scoped file |
...
| `obs_engine::RecordingCallbackScope::accepted` | `engine/runtime_recording_v2.cpp` | — | 1 | — | 4 | new cohesive helper/function in scoped file |
| `obs_engine::ReplayCallbackScope::accepted` | `engine/runtime_replay_buffer_v2.cpp` | — | 1 | — | 4 | new cohesive helper/function in scoped file |
...
| `obs_engine::Engine::v2_prepare_streaming_shutdown` | `engine/runtime_streaming_v2.cpp` | — | 1 | — | 4 | new cohesive helper/function in scoped file |
...
| `obs_encoder_update` | `libobs/obs-encoder.c` | — | 1 | — | 4 | new cohesive helper/function in scoped file |
...
| `Request-Task21UnGuarded` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 1 | — | 3 | new cohesive helper/function in scoped file |
| `New-Task22Binding` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 1 | — | 3 | new cohesive helper/function in scoped file |
...
| `Fail-Task21` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
| `Fail-Task22` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
...
| `Fail-Task27Physical` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
| `Fail-Task27` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
| `Fail-Task28Physical` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
| `Fail-Task28` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
| `Fail-Task29Physical` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
| `Fail-Task29` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
| `Fail-Task30Physical` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
| `Fail-Task30` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
...
| `obs_engine::AudioCallbackScope::suppressed` | `engine/runtime_audio_v2.cpp` | — | 1 | — | 1 | new cohesive helper/function in scoped file |
...
| Function | File | Before CC | After CC | Before NLOC | After NLOC | Notes |
|---|---|---:|---:|---:|---:|---|
| `<script-body>` | `.github/scripts/engine-protocol-v2-task30-physical.ps1` | — | 9 | — | 29 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task24.ps1` | — | 8 | — | 40 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task23.ps1` | — | 7 | — | 25 | new cohesive helper/function in scoped file |
...
| `<script-body>` | `.github/scripts/engine-protocol-v2-task21.ps1` | — | 6 | — | 21 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task22.ps1` | — | 6 | — | 21 | new cohesive helper/function in scoped file |
...
| `<script-body>` | `.github/scripts/engine-protocol-v2-task30.ps1` | — | 5 | — | 18 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task30-package-audit.ps1` | — | 5 | — | 10 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task28-physical.ps1` | — | 4 | — | 25 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task27-physical.ps1` | — | 4 | — | 23 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task12.ps1` | — | 4 | — | 21 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task29-physical.ps1` | — | 4 | — | 21 | new cohesive helper/function in scoped file |
...
| `<script-body>` | `.github/scripts/engine-protocol-v2-task27-stage-fixture.ps1` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task28-stage-fixture.ps1` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task29-stage-fixture.ps1` | — | 4 | — | 14 | new cohesive helper/function in scoped file |
...
| `<script-body>` | `.github/scripts/engine-protocol-v2-task27-package-audit.ps1` | — | 4 | — | 8 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task28-package-audit.ps1` | — | 4 | — | 8 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task29-package-audit.ps1` | — | 4 | — | 8 | new cohesive helper/function in scoped file |
...
| `<script-body>` | `.github/scripts/engine-protocol-v2-task28.ps1` | — | 3 | — | 19 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task29.ps1` | — | 3 | — | 18 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task27.ps1` | — | 3 | — | 16 | new cohesive helper/function in scoped file |
...
| `<script-body>` | `.github/scripts/engine-protocol-v2-task22-stage-fixture.ps1` | — | 2 | — | 12 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task23-run-bridge-test.ps1` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task24-stage-fixture.ps1` | — | 2 | — | 10 | new cohesive helper/function in scoped file |
...
| `<script-body>` | `.github/scripts/engine-protocol-v2-task27-remove-fixture.ps1` | — | 2 | — | 6 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task28-remove-fixture.ps1` | — | 2 | — | 6 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task29-remove-fixture.ps1` | — | 2 | — | 6 | new cohesive helper/function in scoped file |
...
| `<script-body>` | `.github/scripts/engine-protocol-v2-task27-build-fixture.ps1` | — | 2 | — | 3 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task28-build-fixture.ps1` | — | 2 | — | 3 | new cohesive helper/function in scoped file |
| `<script-body>` | `.github/scripts/engine-protocol-v2-task29-build-fixture.ps1` | — | 2 | — | 3 | new cohesive helper/function in scoped file |
...
- `obs_engine::Engine::v2_virtual_camera_configure` — `engine/runtime_virtual_camera_v2.cpp:348-402`, CC 10, NLOC 55, params 2
...
- `obs_engine::Engine::v2_preview_data` — `engine/runtime_preview_v2.cpp:42-80`, CC 10, NLOC 38, params 0
- `obs_engine::Engine::apply_program_scene_route` — `engine/runtime_program_v2.cpp:100-139`, CC 10, NLOC 38, params 5
- `obs_engine::Engine::v2_recording_add_chapter` — `engine/runtime_recording_v2.cpp:531-567`, CC 10, NLOC 37, params 3
- `obs_engine::Engine::v2_scene_create` — `engine/runtime_v2.cpp:462-504`, CC 10, NLOC 37, params 3
- `obs_engine::Engine::v2_canvas_set_channel` — `engine/runtime_canvas_v2.cpp:715-750`, CC 10, NLOC 36, params 3
- `obs_engine::Engine::v2_sync_source_observers` — `engine/runtime_source_v2.cpp:946-984`, CC 10, NLOC 36, params 0
- `obs_engine::Engine::v2_canvas_remove` — `engine/runtime_canvas_v2.cpp:559-593`, CC 10, NLOC 35, params 3
- `obs_engine::Engine::v2_source_duplicate` — `engine/runtime_source_v2.cpp:1098-1136`, CC 10, NLOC 35, params 3
...
- `obs_engine::Engine::v2_item_set_transform` — `engine/runtime_v2.cpp:612-651`, CC 10, NLOC 34, params 3
- `Get-NonBlankLineCount` — `tools/check-complexity.ps1:1022-1056`, CC 10, NLOC 34, params 1
- `obs_engine::Engine::v2_canvas_set_video_settings` — `engine/runtime_canvas_v2.cpp:635-668`, CC 10, NLOC 32, params 3
- `obs_engine::Engine::v2_item_create_group` — `engine/runtime_item_v2.cpp:972-1004`, CC 10, NLOC 32, params 3
- `obs_encoder_update_tracked` — `libobs/obs-encoder.c:705-741`, CC 10, NLOC 32, params 6
- `init_encoder` — `libobs/obs-encoder.c:82-115`, CC 10, NLOC 31, params 4
- `obs_engine::Engine::v2_settle_filter_mutation` — `engine/runtime_filter_v2.cpp:1599-1630`, CC 10, NLOC 30, params 3
- `obs_engine::Engine::v2_output_remove` — `engine/runtime_output_v2.cpp:1579-1608`, CC 10, NLOC 30, params 3
...
- `obs_engine::Engine::v2_streaming_configure` — `engine/runtime_streaming_v2.cpp:140-164`, CC 10, NLOC 25, params 3
- `Invoke-Task7LiveRead` — `.github/scripts/engine-protocol-v2-task7-properties-smoke.ps1:199-224`, CC 10, NLOC 24, params 1
- `obs_engine::read_clear_secrets` — `engine/runtime_service_v2.cpp:225-248`, CC 10, NLOC 24, params 3
...
- `obs_engine::execute_phase3` — `engine/protocol_phase3_v2.cpp:1382-1404`, CC 10, NLOC 23, params 5
- `obs_engine::prepare` — `engine/protocol_phase2_v2.cpp:408-429`, CC 10, NLOC 22, params 7
- `obs_engine::phase3_dispatch_is_mutating` — `engine/protocol_phase3_v2.cpp:1137-1158`, CC 10, NLOC 22, params 1
...
- `obs_engine::Engine::v2_shutdown_output_entry` — `engine/runtime_output_v2.cpp:1072-1093`, CC 10, NLOC 22, params 2
...
- `obs_engine::read_hotkey_selector` — `engine/runtime_hotkey_v2.cpp:251-270`, CC 10, NLOC 20, params 4
...
- `obs_engine::normalize_replay_path` — `engine/runtime_replay_buffer_v2.cpp:97-114`, CC 10, NLOC 18, params 2
...
- `Assert-Task28LoopbackFiles` — `.github/scripts/engine-protocol-v2-task28-physical.ps1:169-185`, CC 10, NLOC 17, params 1
- `obs_engine::read_video_input_descriptor` — `engine/runtime_encoder_v2.cpp:565-581`, CC 10, NLOC 17, params 4
- `obs_engine::filter_settings_event_matches` — `engine/runtime_filter_v2.cpp:1061-1077`, CC 10, NLOC 17, params 4
- `obs_engine::read_meter_options` — `engine/runtime_audio_v2.cpp:1695-1710`, CC 10, NLOC 16, params 3
- `Get-Task22HotkeyFixtures` — `.github/scripts/engine-protocol-v2-task22.ps1:155-169`, CC 10, NLOC 15, params 1
- `obs_engine::read_scaled_dimensions` — `engine/runtime_encoder_v2.cpp:583-597`, CC 10, NLOC 15, params 4
- `Get-WorkflowInterpreter` — `tools/check-complexity.ps1:499-513`, CC 10, NLOC 14, params 1
- `obs_engine::is_phase3_method` — `engine/protocol_phase3_v2.cpp:1443-1454`, CC 10, NLOC 12, params 1
- `obs_engine::output_kind_supports_proc` — `engine/runtime_recording_v2.cpp:220-231`, CC 10, NLOC 12, params 2
- `Assert-ColorEvidence` — `.github/scripts/engine-protocol-v2-task17.ps1:145-153`, CC 10, NLOC 9, params 4
- `obs_engine::phase3_dispatch_empty` — `engine/protocol_phase3_v2.cpp:1127-1135`, CC 10, NLOC 9, params 1
...
- `Invoke-Task22BindingChecks` — `.github/scripts/engine-protocol-v2-task22.ps1:215-266`, CC 9, NLOC 52, params 1
- `obs_engine::Engine::v2_replay_buffer_save` — `engine/runtime_replay_buffer_v2.cpp:381-427`, CC 9, NLOC 47, params 2
- `Get-PathScopeState` — `tools/check-complexity.ps1:2946-2993`, CC 9, NLOC 47, params 1
- `obs_engine::Engine::v2_preview_set_scene` — `engine/runtime_preview_v2.cpp:102-148`, CC 9, NLOC 44, params 3
- `main` — `engine/task23_encoder_bridge_test.cpp:188-231`, CC 9, NLOC 44, params 0
- `obs_engine::Engine::v2_transition_create` — `engine/runtime_transition_v2.cpp:452-497`, CC 9, NLOC 43, params 3
- `obs_engine::Engine::v2_source_remove` — `engine/runtime_v2.cpp:411-459`, CC 9, NLOC 43, params 3
...
- `obs_engine::Engine::v2_prepare_audio_shutdown` — `engine/runtime_audio_v2.cpp:1267-1302`, CC 9, NLOC 36, params 0
- `obs_engine::Engine::v2_filter_prepare_parent_removal` — `engine/runtime_filter_v2.cpp:1544-1581`, CC 9, NLOC 36, params 2
- `obs_engine::Engine::v2_service_create` — `engine/runtime_service_v2.cpp:437-472`, CC 9, NLOC 36, params 3
...
- `obs_engine::Engine::v2_set_output_encoder_slot` — `engine/runtime_output_v2.cpp:1789-1820`, CC 9, NLOC 32, params 6
- `obs_engine::Engine::v2_output_set_reconnect` — `engine/runtime_output_v2.cpp:2088-2119`, CC 9, NLOC 32, params 3
- `obs_engine::Engine::v2_replay_buffer_configure` — `engine/runtime_replay_buffer_v2.cpp:305-336`, CC 9, NLOC 32, params 3
...
- `obs_engine::handle_filter_request` — `engine/protocol_filter_v2.cpp:699-737`, CC 9, NLOC 30, params 5
- `obs_engine::Engine::v2_sanitize_output_error` — `engine/runtime_output_v2.cpp:852-881`, CC 9, NLOC 30, params 1
...
- `obs_engine::Engine::v2_output_rename` — `engine/runtime_output_v2.cpp:1610-1638`, CC 9, NLOC 29, params 3
- `obs_engine::Engine::v2_recording_split_file` — `engine/runtime_recording_v2.cpp:501-529`, CC 9, NLOC 29, params 2
...
- `obs_engine::Engine::v2_encoder_group_add` — `engine/runtime_encoder_group_v2.cpp:185-211`, CC 9, NLOC 27, params 3
- `obs_engine::Engine::v2_hotkey_import` — `engine/runtime_hotkey_v2.cpp:1195-1221`, CC 9, NLOC 27, params 3
- `obs_engine::publish_deferred_source_snapshot` — `engine/runtime_source_v2.cpp:480-508`, CC 9, NLOC 27, params 2
- `Invoke-Task30Available` — `.github/scripts/engine-protocol-v2-task30.ps1:121-146`, CC 9, NLOC 26, params 1
...
- `obs_engine::Engine::v2_start_output_entry` — `engine/runtime_output_v2.cpp:1248-1273`, CC 9, NLOC 26, params 4
- `obs_engine::Engine::v2_update_output_settings` — `engine/runtime_output_v2.cpp:1640-1665`, CC 9, NLOC 26, params 6
...
- `obs_engine::collect_output_signal` — `engine/runtime_output_v2.cpp:540-567`, CC 9, NLOC 25, params 3
- `obs_engine::Engine::v2_recording_configure` — `engine/runtime_recording_v2.cpp:391-415`, CC 9, NLOC 25, params 3
...
- `obs_engine::publish_deferred_output_snapshot` — `engine/runtime_output_v2.cpp:827-848`, CC 9, NLOC 22, params 2
- `Invoke-Task15ProgramRouting` — `.github/scripts/engine-protocol-v2-task15.ps1:121-141`, CC 9, NLOC 21, params 1
- `Assert-Task30ColorCapture` — `.github/scripts/engine-protocol-v2-task30-physical.ps1:101-121`, CC 9, NLOC 21, params 5
...
- `obs_engine::read_meter_source_handles` — `engine/runtime_audio_v2.cpp:1674-1693`, CC 9, NLOC 20, params 3
...
- `obs_engine::read_recording_path_options` — `engine/runtime_recording_v2.cpp:158-175`, CC 9, NLOC 18, params 3
- `Assert-Task29PhysicalFile` — `.github/scripts/engine-protocol-v2-task29-physical.ps1:127-143`, CC 9, NLOC 17, params 1
- `obs_engine::collect_sensitive_recursive` — `engine/properties_sensitive.cpp:6-22`, CC 9, NLOC 17, params 2
- `obs_engine::read_encoder_create_options` — `engine/runtime_encoder_v2.cpp:182-198`, CC 9, NLOC 17, params 6
...
- `obs_engine::output_is_recording_compatible` — `engine/runtime_recording_v2.cpp:55-70`, CC 9, NLOC 16, params 2
...
- `obs_engine::validate_output_start_slots` — `engine/runtime_output_v2.cpp:1220-1231`, CC 9, NLOC 12, params 3
...
- `obs_encoder_set_group` — `libobs/obs-encoder.c:2320-2367`, CC 8, NLOC 40, params 2
- `Invoke-Task27CreateAndConfigure` — `.github/scripts/engine-protocol-v2-task27.ps1:105-143`, CC 8, NLOC 39, params 1
...
- `obs_engine::Engine::v2_apply_virtual_camera_target` — `engine/runtime_virtual_camera_v2.cpp:264-301`, CC 8, NLOC 38, params 6
- `obs_engine::Engine::v2_properties_get_list_items` — `engine/runtime_properties_v2.cpp:499-538`, CC 8, NLOC 37, params 3
- `obs_engine::Engine::v2_source_get_missing_files` — `engine/runtime_source_v2.cpp:1304-1342`, CC 8, NLOC 37, params 3
...
- `obs_engine::append_scalar_audio_event` — `engine/runtime_audio_v2.cpp:659-692`, CC 8, NLOC 34, params 3
...
- `obs_engine::Engine::v2_item_create` — `engine/runtime_v2.cpp:550-589`, CC 8, NLOC 33, params 3
...
- `obs_engine::handle_phase3_request` — `engine/protocol_phase3_v2.cpp:1456-1490`, CC 8, NLOC 31, params 4
- `obs_engine::Engine::v2_scene_remove` — `engine/runtime_scene_v2.cpp:688-720`, CC 8, NLOC 31, params 3
...
- `obs_engine::Engine::v2_output_create` — `engine/runtime_output_v2.cpp:1549-1577`, CC 8, NLOC 29, params 3
...
- `obs_engine::Engine::v2_canvas_rename` — `engine/runtime_canvas_v2.cpp:595-622`, CC 8, NLOC 28, params 3
- `obs_engine::settle_pending_update` — `engine/runtime_encoder_v2.cpp:408-435`, CC 8, NLOC 28, params 7
- `obs_engine::Engine::v2_add_filter_observer` — `engine/runtime_filter_v2.cpp:1312-1341`, CC 8, NLOC 28, params 1
- `obs_engine::recording_file_changed_callback` — `engine/runtime_recording_v2.cpp:271-298`, CC 8, NLOC 28, params 2
- `obs_canvas_reset_video_internal` — `libobs/obs-canvas.c:320-351`, CC 8, NLOC 28, params 2
- `obs_engine::Engine::v2_audio_set_monitoring_device` — `engine/runtime_audio_v2.cpp:1764-1790`, CC 8, NLOC 27, params 3
- `obs_engine::Engine::v2_encoder_roi_remove` — `engine/runtime_encoder_v2.cpp:1129-1155`, CC 8, NLOC 27, params 3
- `obs_engine::Engine::command_scene_create` — `engine/runtime.cpp:466-495`, CC 8, NLOC 27, params 2
...
- `obs_engine::Engine::v2_stop_output_entry` — `engine/runtime_output_v2.cpp:1275-1300`, CC 8, NLOC 26, params 5
- `obs_engine::replay_saved_callback` — `engine/runtime_replay_buffer_v2.cpp:226-251`, CC 8, NLOC 26, params 1
...
- `obs_engine::Engine::v2_append_output_encoder_dependency_events` — `engine/runtime_output_v2.cpp:1177-1200`, CC 8, NLOC 24, params 3
...
- `obs_engine::Engine::v2_output_set_paused` — `engine/runtime_output_v2.cpp:2012-2034`, CC 8, NLOC 23, params 3
- `obs_engine::Engine::v2_source_rename` — `engine/runtime_source_v2.cpp:1138-1163`, CC 8, NLOC 23, params 3
...
- `obs_engine::Engine::v2_record_output_encoder_slot` — `engine/runtime_output_v2.cpp:1725-1745`, CC 8, NLOC 21, params 6
...
- `Read-Task22Message` — `.github/scripts/engine-protocol-v2-task22.ps1:55-71`, CC 8, NLOC 17, params 1
...
- `obs_engine::read_delay_request` — `engine/runtime_output_v2.cpp:1361-1376`, CC 8, NLOC 16, params 4
...
- `obs_engine::protocol_supported` — `engine/runtime_streaming_v2.cpp:26-40`, CC 8, NLOC 15, params 2
- `Get-Task21Kinds` — `.github/scripts/engine-protocol-v2-task21.ps1:203-216`, CC 8, NLOC 14, params 1
- `Invoke-Task8Rename` — `.github/scripts/engine-protocol-v2-task8-source-smoke.ps1:198-211`, CC 8, NLOC 14, params 1
- `obs_engine::parse_handle_text` — `engine/runtime_audio_v2.cpp:230-243`, CC 8, NLOC 14, params 2
...
- `obs_engine::validate_output_service_target` — `engine/runtime_output_v2.cpp:1940-1953`, CC 8, NLOC 14, params 4
...
- `obs_engine::Engine::v2_validate_recording_configuration` — `engine/runtime_recording_v2.cpp:349-361`, CC 8, NLOC 13, params 4
...
- `Assert-Task21StateEvent` — `.github/scripts/engine-protocol-v2-task21.ps1:127-136`, CC 8, NLOC 10, params 4
...
- `obs_engine::read_registerer_type` — `engine/runtime_hotkey_v2.cpp:213-221`, CC 8, NLOC 9, params 4
...
- `obs_engine::Engine::v2_audio_subscribe_meters` — `engine/runtime_audio_v2.cpp:1792-1830`, CC 7, NLOC 39, params 3
...
- `obs_engine::Engine::v2_virtual_camera_get_capabilities` — `engine/runtime_virtual_camera_v2.cpp:312-346`, CC 7, NLOC 35, params 2
...
- `obs_engine::Engine::v2_scene_remove` — `engine/runtime_v2.cpp:506-545`, CC 7, NLOC 33, params 3
- `obs_engine::Engine::command_scene_add` — `engine/runtime.cpp:520-555`, CC 7, NLOC 33, params 2
- `New-Task21Graph` — `.github/scripts/engine-protocol-v2-task21.ps1:234-264`, CC 7, NLOC 31, params 1
...
- `obs_engine::take_deferred_output_events` — `engine/runtime_output_v2.cpp:796-825`, CC 7, NLOC 30, params 3
- `Invoke-WorkflowExecutableAudit` — `tools/check-complexity.ps1:584-614`, CC 7, NLOC 30, params 1
- `obs_engine::Engine::v2_prepare_output_shutdown` — `engine/runtime_output_v2.cpp:1095-1123`, CC 7, NLOC 29, params 0
...
- `obs_engine::Engine::v2_output_set_service` — `engine/runtime_output_v2.cpp:1851-1877`, CC 7, NLOC 27, params 3
...
- `Invoke-Task30PhysicalColor` — `.github/scripts/engine-protocol-v2-task30-physical.ps1:142-167`, CC 7, NLOC 26, params 7
- `obs_engine::read_canvas_target` — `engine/runtime_canvas_v2.cpp:350-375`, CC 7, NLOC 26, params 4
- `obs_engine::Engine::v2_output_set_delay` — `engine/runtime_output_v2.cpp:2050-2075`, CC 7, NLOC 26, params 3
...
- `Invoke-Task29SaveRace` — `.github/scripts/engine-protocol-v2-task29.ps1:135-158`, CC 7, NLOC 24, params 1
- `obs_engine::handle_session_method` — `engine/protocol_v2.cpp:698-721`, CC 7, NLOC 24, params 4
- `obs_engine::Engine::v2_encoder_set_scale_filter` — `engine/runtime_encoder_v2.cpp:1069-1092`, CC 7, NLOC 24, params 3
...
- `obs_engine::publish_audio_events` — `engine/runtime_audio_v2.cpp:540-562`, CC 7, NLOC 23, params 3
- `obs_engine::Engine::v2_encoder_remove` — `engine/runtime_encoder_v2.cpp:787-809`, CC 7, NLOC 23, params 3
...
- `obs_engine::Engine::v2_end_output_event_capture` — `engine/runtime_output_v2.cpp:996-1016`, CC 7, NLOC 21, params 0
...
- `obs_engine::read_bindings` — `engine/runtime_hotkey_v2.cpp:344-363`, CC 7, NLOC 20, params 3
...
- `obs_engine::canonicalize_recording_path` — `engine/runtime_recording_v2.cpp:129-148`, CC 7, NLOC 20, params 4
...
- `Read-Task23Event` — `.github/scripts/engine-protocol-v2-task23.ps1:83-100`, CC 7, NLOC 18, params 2
...
- `obs_engine::Engine::v2_apply_output_service_binding` — `engine/runtime_output_v2.cpp:1832-1849`, CC 7, NLOC 18, params 5
- `obs_engine::phase2_scale_filter_name` — `engine/runtime_phase2_common.cpp:205-222`, CC 7, NLOC 18, params 1
- `obs_engine::prepare_recording_path_parent` — `engine/runtime_recording_v2.cpp:110-127`, CC 7, NLOC 18, params 3
...
- `obs_engine::Engine::v2_apply_recording_configuration_settings` — `engine/runtime_recording_v2.cpp:363-379`, CC 7, NLOC 17, params 5
...
- `obs_engine::audio_meter_callback` — `engine/runtime_audio_v2.cpp:788-803`, CC 7, NLOC 16, params 1
- `obs_engine::validate_studio_transition_request` — `engine/runtime_studio_v2.cpp:33-48`, CC 7, NLOC 16, params 5
- `start_runtime` — `engine/task23_encoder_bridge_test.cpp:114-129`, CC 7, NLOC 16, params 0
...
- `Read-PhysicalEvent` — `.github/scripts/engine-protocol-v2-task28-physical.ps1:90-103`, CC 7, NLOC 14, params 2
- `Read-Task28Event` — `.github/scripts/engine-protocol-v2-task28.ps1:69-82`, CC 7, NLOC 14, params 2
- `obs_engine::read_modifier_entry` — `engine/runtime_hotkey_v2.cpp:280-293`, CC 7, NLOC 14, params 3
- `obs_engine::validate_output_encoder_target` — `engine/runtime_output_v2.cpp:1747-1760`, CC 7, NLOC 14, params 4
...
- `Read-PhysicalEvent` — `.github/scripts/engine-protocol-v2-task27-physical.ps1:58-70`, CC 7, NLOC 13, params 2
- `Assert-PhysicalFile` — `.github/scripts/engine-protocol-v2-task27-physical.ps1:161-173`, CC 7, NLOC 13, params 2
- `Read-Task27Event` — `.github/scripts/engine-protocol-v2-task27.ps1:65-77`, CC 7, NLOC 13, params 2
- `Read-Task29PhysicalEvent` — `.github/scripts/engine-protocol-v2-task29-physical.ps1:57-69`, CC 7, NLOC 13, params 2
- `Read-Task29Event` — `.github/scripts/engine-protocol-v2-task29.ps1:63-75`, CC 7, NLOC 13, params 2
- `Read-Task30PhysicalEvent` — `.github/scripts/engine-protocol-v2-task30-physical.ps1:59-71`, CC 7, NLOC 13, params 2
- `Read-Task30Event` — `.github/scripts/engine-protocol-v2-task30.ps1:75-87`, CC 7, NLOC 13, params 2
- `Invoke-Task8Duplicate` — `.github/scripts/engine-protocol-v2-task8-source-smoke.ps1:213-225`, CC 7, NLOC 13, params 1
- `obs_engine::parse_v2_request_options` — `engine/protocol_v2.cpp:831-843`, CC 7, NLOC 13, params 3
- `obs_engine::registerer_matches` — `engine/runtime_hotkey_v2.cpp:571-583`, CC 7, NLOC 13, params 2
- `obs_engine::streaming_service_compatible` — `engine/runtime_streaming_v2.cpp:66-78`, CC 7, NLOC 13, params 2
- `Assert-P2PhysicalCancellationSettled` — `.github/scripts/engine-protocol-v2-phase2-physical.ps1:507-518`, CC 7, NLOC 12, params 1
- `Assert-Task22Event` — `.github/scripts/engine-protocol-v2-task22.ps1:118-129`, CC 7, NLOC 12, params 4
- `Read-Task25Event` — `.github/scripts/engine-protocol-v2-task25.ps1:60-71`, CC 7, NLOC 12, params 2
- `obs_engine::read_gating_fields` — `engine/runtime_audio_v2.cpp:1007-1018`, CC 7, NLOC 12, params 4
...
- `obs_engine::read_virtual_target_object` — `engine/runtime_virtual_camera_v2.cpp:65-76`, CC 7, NLOC 12, params 4
- `Read-Task24Event` — `.github/scripts/engine-protocol-v2-task24.ps1:55-65`, CC 7, NLOC 11, params 2
...
- `Assert-FiniteMeter` — `.github/scripts/engine-protocol-v2-task21.ps1:149-157`, CC 7, NLOC 9, params 1
- `Invoke-Task25SecretChecks` — `.github/scripts/engine-protocol-v2-task25.ps1:111-119`, CC 7, NLOC 9, params 3
...
- `obs_engine::Engine::v2_output_state` — `engine/runtime_output_v2.cpp:883-925`, CC 6, NLOC 43, params 2
- `obs_engine::Engine::v2_prepare_shutdown` — `engine/runtime_source_v2.cpp:986-1029`, CC 6, NLOC 42, params 0
...
- `obs_engine::Engine::v2_virtual_camera_unconfigure` — `engine/runtime_virtual_camera_v2.cpp:404-435`, CC 6, NLOC 32, params 2
...
- `remove_connection` — `libobs/obs-encoder.c:418-457`, CC 6, NLOC 31, params 2
...
- `obs_engine::Engine::v2_source_load_state` — `engine/runtime_source_v2.cpp:1370-1401`, CC 6, NLOC 29, params 3
- `Invoke-Task22AudioRoutingCheck` — `.github/scripts/engine-protocol-v2-task22.ps1:268-295`, CC 6, NLOC 28, params 1
- `obs_engine::Engine::v2_canvas_create` — `engine/runtime_canvas_v2.cpp:530-557`, CC 6, NLOC 28, params 3
...
- `obs_engine::handle_v2_request` — `engine/protocol_v2.cpp:924-955`, CC 6, NLOC 26, params 4
...
- `obs_engine::handle_runtime_method` — `engine/protocol_v2.cpp:757-786`, CC 6, NLOC 25, params 8
- `obs_engine::Engine::v2_scene_get_state` — `engine/runtime_scene_v2.cpp:652-676`, CC 6, NLOC 25, params 3
- `obs_engine::Engine::command_source_types` — `engine/runtime.cpp:295-319`, CC 6, NLOC 25, params 1
...
- `obs_engine::get_registerer` — `engine/runtime_hotkey_v2.cpp:496-519`, CC 6, NLOC 24, params 2
...
- `obs_engine::Engine::v2_audio_set_monitoring_enabled` — `engine/runtime_audio_v2.cpp:1468-1490`, CC 6, NLOC 23, params 3
- `obs_engine::Engine::v2_canvas_list_scenes` — `engine/runtime_canvas_v2.cpp:670-692`, CC 6, NLOC 23, params 3
- `obs_engine::Engine::v2_prepare_encoder_shutdown` — `engine/runtime_encoder_v2.cpp:611-633`, CC 6, NLOC 23, params 0
...
- `obs_engine::Engine::v2_audio_set_sync_offset` — `engine/runtime_audio_v2.cpp:1431-1452`, CC 6, NLOC 22, params 3
- `obs_engine::Engine::v2_register_attached_filter` — `engine/runtime_filter_v2.cpp:779-800`, CC 6, NLOC 22, params 4
- `obs_engine::Engine::v2_replay_buffer_unconfigure` — `engine/runtime_replay_buffer_v2.cpp:338-359`, CC 6, NLOC 22, params 2
...
- `obs_engine::resolve_single_hotkey` — `engine/runtime_hotkey_v2.cpp:654-673`, CC 6, NLOC 20, params 5
...
- `Invoke-Task29PhysicalReplay` — `.github/scripts/engine-protocol-v2-task29-physical.ps1:107-125`, CC 6, NLOC 19, params 1
...
- `obs_engine::Engine::v2_forget_audio_hotkey` — `engine/runtime_hotkey_v2.cpp:911-929`, CC 6, NLOC 19, params 1
- `obs_engine::Engine::v2_append_recording_output_events` — `engine/runtime_recording_v2.cpp:640-658`, CC 6, NLOC 19, params 2
...
- `obs_engine::prepare_canvas_video_update` — `engine/runtime_canvas_v2.cpp:470-487`, CC 6, NLOC 18, params 7
- `obs_engine::read_binding_modifiers` — `engine/runtime_hotkey_v2.cpp:295-312`, CC 6, NLOC 18, params 3
...
- `obs_engine::create_private_source_media` — `engine/runtime_virtual_camera_v2.cpp:157-174`, CC 6, NLOC 18, params 3
...
- `obs_engine::make_meter_subscription` — `engine/runtime_audio_v2.cpp:982-999`, CC 6, NLOC 17, params 6
- `obs_engine::replace_gating_event` — `engine/runtime_audio_v2.cpp:1043-1059`, CC 6, NLOC 17, params 3
- `obs_engine::read_canvas_flags` — `engine/runtime_canvas_v2.cpp:444-460`, CC 6, NLOC 17, params 3
- `obs_engine::take_hotkey_triggers` — `engine/runtime_hotkey_v2.cpp:745-761`, CC 6, NLOC 17, params 5
...
- `Invoke-Task27Lifecycle` — `.github/scripts/engine-protocol-v2-task27.ps1:145-160`, CC 6, NLOC 16, params 1
...
- `obs_engine::virtual_target_name` — `engine/runtime_virtual_camera_v2.cpp:31-46`, CC 6, NLOC 16, params 1
- `obs_engine::parse_virtual_target_name` — `engine/runtime_virtual_camera_v2.cpp:48-63`, CC 6, NLOC 16, params 2
...
- `Invoke-Task29Configure` — `.github/scripts/engine-protocol-v2-task29.ps1:111-125`, CC 6, NLOC 15, params 1
...
- `obs_engine::read_last_replay_path` — `engine/runtime_replay_buffer_v2.cpp:210-224`, CC 6, NLOC 15, params 2
...
- `obs_engine::Engine::v2_validate_output_start` — `engine/runtime_output_v2.cpp:1233-1246`, CC 6, NLOC 14, params 2
...
- `Stop-Task21Engine` — `.github/scripts/engine-protocol-v2-task21.ps1:48-59`, CC 6, NLOC 12, params 1
- `Read-Task21Meter` — `.github/scripts/engine-protocol-v2-task21.ps1:159-170`, CC 6, NLOC 12, params 2
- `Stop-Task23Engine` — `.github/scripts/engine-protocol-v2-task23.ps1:37-48`, CC 6, NLOC 12, params 1
...
- `obs_engine::output_is_replay_compatible` — `engine/runtime_replay_buffer_v2.cpp:52-63`, CC 6, NLOC 12, params 2
...
- `Invoke-Task30Unavailable` — `.github/scripts/engine-protocol-v2-task30.ps1:109-119`, CC 6, NLOC 11, params 1
...
- `obs_engine::read_requested_monitoring_device` — `engine/runtime_audio_v2.cpp:1646-1656`, CC 6, NLOC 11, params 3
...
- `obs_engine::prepare_runtime_result` — `engine/protocol_v2.cpp:731-740`, CC 6, NLOC 10, params 6
...
- `obs_engine::read_service_kind` — `engine/runtime_service_v2.cpp:88-97`, CC 6, NLOC 10, params 3
...
- `Stop-Task28PhysicalEngine` — `.github/scripts/engine-protocol-v2-task28-physical.ps1:56-62`, CC 6, NLOC 7, params 1
- `Stop-Task28Engine` — `.github/scripts/engine-protocol-v2-task28.ps1:30-36`, CC 6, NLOC 7, params 1
