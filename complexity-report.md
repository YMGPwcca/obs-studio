...
Candidate measurement HEAD: `3251102af1e62192d22a35cb5a39ce0fb6add98d`

## Before/after summary

| Measure | Before | After |
|---|---:|---:|
| Scoped functions | 543 | 986 |
| Average CC | 5.703 | 3.797 |
| Median CC | 4 | 3 |
| 90th percentile CC | 13 | 7 |
| Maximum CC | 61 | 13 |
| Functions with CC > 5 | 171 | 227 |
| Functions with CC > 7 | 115 | 95 |
...
|---|---:|---:|
| Script bodies | 5 | 7 |
| Average Script bodies CC | 36.2 | 2.286 |
...
| Measure | Before | After |
|---|---:|---:|
| Enforced scopes | 548 | 993 |
| Average Enforced scopes CC | 5.982 | 3.787 |
| Median Enforced scopes CC | 4 | 3 |
| 90th percentile Enforced scopes CC | 13 | 7 |
| Maximum Enforced scopes CC | 80 | 13 |
| Enforced scopes with CC > 5 | 175 | 227 |
| Enforced scopes with CC > 7 | 119 | 95 |
...
| `Invoke-AfterMode` | `tools/check-complexity.ps1` | — | 4 | — | 16 | new cohesive helper/function in scoped file |
...
| `New-ComparisonMarkdown` | `tools/check-complexity.ps1` | — | 1 | — | 49 | new cohesive helper/function in scoped file |
| `New-InventoryContext` | `tools/check-complexity.ps1` | — | 1 | — | 39 | new cohesive helper/function in scoped file |
| `New-ReportObject` | `tools/check-complexity.ps1` | — | 1 | — | 36 | new cohesive helper/function in scoped file |
| `New-ComplexityRunContext` | `tools/check-complexity.ps1` | — | 1 | — | 28 | new cohesive helper/function in scoped file |
...
| Function | File | Before CC | After CC | Before NLOC | After NLOC | Notes |
|---|---|---:|---:|---:|---:|---|
| `<script-body>` | `tools/check-complexity.tests.ps1` | — | 5 | — | 311 | new cohesive helper/function in scoped file |
...
- `Get-OperatorBlameLines` — `tools/check-complexity.ps1:355-396`, CC 10, NLOC 41, params 1
...
- `Get-NonBlankLineCount` — `tools/check-complexity.ps1:649-683`, CC 10, NLOC 34, params 1
...
- `Get-PostHistoryRecreatedPaths` — `tools/check-complexity.ps1:2419-2437`, CC 10, NLOC 18, params 1
...
- `Get-PathScopeState` — `tools/check-complexity.ps1:2490-2537`, CC 9, NLOC 47, params 1
- `New-AutomaticIdentity` — `tools/check-complexity.ps1:1267-1308`, CC 9, NLOC 41, params 1
...
- `Get-UnmigratedIdentityViolations` — `tools/check-complexity.ps1:1397-1433`, CC 9, NLOC 36, params 1
...
- `Get-PathScopeLines` — `tools/check-complexity.ps1:2539-2571`, CC 9, NLOC 32, params 1
...
- `Update-PostAcceptedPathProvenance` — `tools/check-complexity.ps1:494-524`, CC 9, NLOC 30, params 1
- `Get-IdentityMigrationCurrent` — `tools/check-complexity.ps1:1011-1039`, CC 9, NLOC 28, params 1
...
- `Read-IdentityMigrationEntries` — `tools/check-complexity.ps1:945-971`, CC 9, NLOC 26, params 1
...
- `Invoke-CheckMode` — `tools/check-complexity.ps1:3041-3073`, CC 8, NLOC 32, params 1
...
- `Get-AstDecisionWeight` — `tools/check-complexity.ps1:728-755`, CC 8, NLOC 27, params 1
...
- `New-OperatorCodeCommitRecords` — `tools/check-complexity.ps1:2749-2774`, CC 8, NLOC 25, params 1
...
- `Test-MetricInScope` — `tools/check-complexity.ps1:1458-1480`, CC 8, NLOC 22, params 1
...
- `New-PowerShellScriptBodyMetric` — `tools/check-complexity.ps1:1529-1572`, CC 7, NLOC 43, params 1
- `Invoke-Task11SourceDuplicate` — `.github/scripts/engine-protocol-v2-task11.ps1:666-705`, CC 7, NLOC 40, params 1
- `New-ScopeContext` — `tools/check-complexity.ps1:2655-2695`, CC 7, NLOC 40, params 1
...
- `Merge-IdentityMigrationMaps` — `tools/check-complexity.ps1:1101-1132`, CC 7, NLOC 31, params 1
- `obs_engine::queue_deferred_media_events_locked` — `engine/runtime_media_v2.cpp:412-439`, CC 7, NLOC 28, params 6
- `Find-BeforeMetric` — `tools/check-complexity.ps1:1991-2019`, CC 7, NLOC 28, params 1
...
- `New-InclusionBaselineMap` — `tools/check-complexity.ps1:2282-2304`, CC 7, NLOC 22, params 1
...
- `Get-WorkingTreeRecreatedPaths` — `tools/check-complexity.ps1:442-463`, CC 7, NLOC 21, params 1
- `Get-NonCyclomaticCategory` — `tools/check-complexity.ps1:2802-2823`, CC 7, NLOC 21, params 1
...
- `Get-CeilingMetricViolations` — `tools/check-complexity.ps1:2944-2960`, CC 7, NLOC 16, params 1
...
- `New-HistoryContext` — `tools/check-complexity.ps1:2338-2387`, CC 6, NLOC 49, params 1
- `Start-EngineCase` — `.github/scripts/engine-protocol-v2-task8-concurrency.ps1:71-121`, CC 6, NLOC 44, params 1
- `Get-PowerShellFileMetrics` — `tools/check-complexity.ps1:1574-1614`, CC 6, NLOC 40, params 1
...
- `Get-LizardRows` — `tools/check-complexity.ps1:582-616`, CC 6, NLOC 32, params 1
...
- `Validate-Allowlist` — `tools/check-complexity.ps1:846-870`, CC 6, NLOC 24, params 1
...
- `Get-HistoricalPathAliases` — `tools/check-complexity.ps1:546-568`, CC 6, NLOC 22, params 1
...
- `Assert-JsonUniqueProperties` — `tools/check-complexity.ps1:973-993`, CC 6, NLOC 20, params 1
...
- `Assert-IdentityMigrationFunctionIdentity` — `tools/check-complexity.ps1:1188-1206`, CC 6, NLOC 18, params 1
...
- `Get-ReportStatistics` — `tools/check-complexity.ps1:1760-1776`, CC 6, NLOC 16, params 1
