...
try {
    ...
    Assert-CheckerFailure $caseAAResult 'CASE AA inline PowerShell requires extraction' 'non-trivial'
    ...
    Assert-CheckerFailure $caseABResult 'CASE AB inline PowerShell function requires extraction' 'non-trivial'
    ...
    Assert-CheckerFailure $caseAHOldResult 'CASE AH original workflow executable policy' 'non-trivial'
    ...
    Assert-CheckerFailure $caseAHNewResult 'CASE AH renamed workflow executable policy' 'non-trivial'
    ...
    Assert-CheckerFailure $caseAIResult 'CASE AI untracked workflow executable policy' 'non-trivial'
